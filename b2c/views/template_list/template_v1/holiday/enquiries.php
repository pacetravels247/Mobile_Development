	...
	<table class="table table-bordered">
		...
		<?php
			...
			foreach($tours_enquiry AS $key=>$te){
				...
				$package_details=$this->custom_db->single_table_records('tours','*',array('tour_code'=>$te['tour_code']))['data'][0];
				if($te['te_status']==1)
		...
		?>
			<tr>
				...
				<td><?=$te["phone"]?></td>
				<td><?php if($package_details['package_type']=='group'){echo "Grouped / Fixed";}else{echo "FIT / Customised";}?></td>
