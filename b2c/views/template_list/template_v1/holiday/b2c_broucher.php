...
<?php  if($menu == true){ ?>
  <div class="container">
    <div class="col-xs-12 text-center mt50">
      <ul class="list-inline btn_sec" style="margin: 20px 0px;">
        <li>
...
<?php } ?>
  <table cellspacing="0" cellpadding="10" border="0" style="border: 2px solid #eeeeee; background: #ffffff; font-size: 14px; line-height: 20px; width: 100%; max-width: 600px; margin: 0px auto 20px; font-family: cambria, serif; color:#222;text-align: justify;word-spacing: 5px;">
  <tbody>
  <tr>
           ...
           <!-- <p style="margin:0;">Overnight at hotel <?=$itinary['hotel_name']?></p>
            ...
            <span style="margin:0 0 2px; font-weight:bold">Meal Plan:
			  ...
			  foreach($imag_array as $im){
				  if($im!=''){
				echo '<img style="width:150px;height:150px;display: inline-block;margin-right:5px;" src="'.SYSTEM_IMAGE_FULL_PATH_TO_EXTRA.$this->template->domain_images($im).'">';
				  }
			  }
