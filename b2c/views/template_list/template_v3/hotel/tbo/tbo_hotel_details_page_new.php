...
<div class="innertabs">
	...
	<div class="">
		<div id="room-list_<?=$params['result_index']?>" class="room-list romlistnh short-text1 room-list_<?=$sanitized_data['HotelCode']?>">
...
$(document).ready(function() {
	...
	$('.movetop').click(function(){
	 ...
	 $(".show-more-fac a").on("click", function() {
		...
		var $content = $link.parent().prev("div.short-text2");
		var linkText = $links;
