...
$transaction_id = $booking_details['booking_source'];
...
function get_booking_info($booking_details)
{
	...
	$booked_pax_name = $booking_details['customer_details'][0]['name'];
		...
		<td colspan="2" style="padding: 5px 20px;">
		   ...
		   $fare_details .= ' <tr>
					...
					<td style="padding: 5px 0px;" align="right">
						<h4 style="margin:0;margin-top:5px;color: #337ab7;"><i class="fa fa-rupee"></i> '.$booking_details['grand_total'].'</h4>
					</td>
				</tr>
			</table>
		</td>
