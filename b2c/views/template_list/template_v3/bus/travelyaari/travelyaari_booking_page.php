...
$Markup = $markup_total_fare - $total_fare+$convenience_fees;
  	//Adding GST
    $gst_value = 0;
   	if($Markup > 0 ){
						...
						<div class="insiefare">
							...
							<div class="fredivs">
							   ...
							   <div class="reptalltftr">
									<div class="col-xs-8 nopadding">
										<div class="farestybus">Base Fare</div>
									</div>
									<div class="col-xs-4 nopadding">
										<div class="amnterbus arimobold"><?=$default_currency_symbol?> <?=roundoff_number($markup_total_fare-$service_tax)?> </div>
									</div>
								</div>
								<?php if($service_tax > 0){?>
									<div class="reptalltftr">
									<div class="col-xs-8 nopadding">
										<div class="farestybus">Service Tax</div>
									</div>
									<div class="col-xs-4 nopadding">
										<div class="amnterbus arimobold"><?=$default_currency_symbol?> <?=roundoff_number($service_tax)?> </div>
									</div>
								</div>
								<?php } ?>
								<div class="clearfix"></div>
								...
								<div class="reptalltftr">
									<div class="col-xs-8 nopadding">
										<div class="farestybus">GST</div>
									</div>
									<div class="col-xs-4 nopadding">
										<div class="amnterbus arimobold"><?=$default_currency_symbol?> <?=roundoff_number($gst_value)?> </div>
									</div>
								</div>
								<?php } ?>
								<div class="reptalltftr">
									<div class="col-xs-8 nopadding">
										<div class="farestybus">Convenience Fee</div>
									</div>
									<div class="col-xs-4 nopadding">
										<div class="amnterbus arimobold"><?=$default_currency_symbol?> <span class="convenience_fees">0.00</span></div>
									</div>
								</div>
								<div class="reptalltftr">
									<div class="col-xs-8 nopadding">
										<div class="farestybus">Grand Total</div>
									</div>
									<div class="col-xs-4 nopadding">
										<div id="t_fare" class="amnterbus arimobold grandtotal t_fare"><?=$default_currency_symbol?> <?=roundoff_number($markup_total_fare+$gst_value+$convenience_fees)?> </div>
									</div>
								</div>
							</div>
						</div>
...
if($social1){
	...
	<a class="logspecify tweetcolor"><span class="fa fa-twitter"></span><div class="mensionsoc">Login with Twitter</div></a>
							...
							<div class="fredivs">
							   ...
							   <div class="clearfix"></div>
								<div class="reptalltftr">
									...
									<div class="col-xs-4 nopadding">
										<div class="amnterbus arimobold grandtotal t_fare"><?=$default_currency_symbol?><span class="grand_total_amount"> <?=roundoff_number($markup_total_fare+$gst_value+$convenience_fees)?></span></div>
									</div>
								</div>
							</div>
						</div>
			...
			?>
				<input type="hidden" name="inventory_type" value="<?=$CUR_Route['inventoryType']?>">
			<?php } ?>
			 <div class="flitab1">
				<div class="moreflt boksectn">
					<div class="ontyp">
					  <div class="labltowr arimobold"><?=ucfirst($CUR_Route['From'])?> to <?=ucfirst($CUR_Route['To'])?><strong>(<?=get_time_duration_label(calculate_duration($CUR_Route['DepartureTime'], $CUR_Route['ArrivalTime']))?>)</strong></div>
						...
						<div class="pasngrinput_enter">
							...
							for($i=0; $i<$seat_count; $i++) {
								...
								$attr['base_fare']= $i_seat['base_fare'];
								$attr['_ServiceTax']= $i_seat['service_tax'];
							?>
							...
							<div class="hide hidden_pax_details">
								...
								<div class="pad_psger">
									...
									<span class="seat_number"> Seat <strong><?=$i_seat['seat_no']?></strong></span>
										...
										<div class="col-xs-5 nopad">
										<div class="pad_psger">
												<input value="<?=@$cur_pax_info['first_name']?>" type="text" maxlength="45" id="contact-name"  name="contact_name[]" class="clainput  alpha_space <?=$traveller_class?> contact-name" required placeholder="Name" data-row-id="<?=($i);?>">
										</div>
										</div>
										...
										<div class="pad_psger">
											...
											<input value="<?=@$cur_pax_info['age']?>" type="text" maxlength="2" id="age-<?=($i);?>" name="age[]" class="clainput _numeric_only age" required placeholder="Age">
										</div>
										</div>
										</div>
							</div>
				                      ...
				                      <div class="cartprc">
				                        <div class="payblnhm singecartpricebuk ritaln">
				                    	 <input type="text" placeholder="Enter Promo" name="code" id="code" class="promocode" aria-required="true" />
				                          ...
				                          <input type="hidden" name="total_amount_val" id="total_amount_val" class="promocode" value="<?=$markup_total_fare+$gst_value;?>" />
				                          <input type="hidden" name="convenience_fee" id="convenience_fee" class="promocode" value="0" />
				...
				<div class="contbk">
					...
					<div class="col-xs-4 nopadding">
					<?php //debug($lead_pax_details);exit;?>
					<!-- <input type="text" placeholder="+91" class="newslterinput nputbrd" readonly> -->
					<select class="newslterinput nputbrd _numeric_only" name="phone_country_code" id="after_country_code">
						<?php echo diaplay_phonecode($phone_code,$active_data, $user_country_code); ?>
					</select> 
					</div>
...
<input type="radio" name="selected_pm" value="PAYPAL" checked/> Paypal
