...
<form action="<?php echo base_url();?>index.php/general/pre_sight_seen_search" 
  ...
  <div class="tabspl forhotelonly">
    <div class="tabrow sightseeing_srch">
      <div class="col-md-offset-2 col-md-8 col-sm-12 col-xs-12 nopad">
        <div class="col-md-12 padfive full_smal_tab mobile_width">
          ...
          <div class="plcetogo plcemark sidebord">           
            ...
            <input type="text" id="activity_destination_search_name" class="fromactivity1 normalinput form-control b-r-0 input_nrml" placeholder="Location" name="from" required value="<?php echo @$destination;?>"/>
