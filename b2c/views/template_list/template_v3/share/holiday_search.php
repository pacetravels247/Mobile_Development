	...
	<div class="tabspl forhotelonly">
		<div class="tabrow holiday_srch">
			...
			<div class="col-md-3 col-sm-3  col-xs-6 padfive full_smal_tab">
				...
				<div class="selectedwrap sidebord">
					<select class="normalsel holyday_selct input_nrml" id="package_type"
						name="package_type">
			...
			<div class="col-md-3 col-sm-3 col-xs-6 padfive full_smal_tab">
				...
				<div class="selectedwrap sidebord">
					<select class="normalsel holyday_selct input_nrml" id="duration"
						name="duration">
			...
			<div class="col-md-3 col-sm-3 col-xs-6 padfive full_smal_tab">
				...
				<div class="selectedwrap sidebord">
					<select class="normalsel holyday_selct input_nrml" id="budget" name="budget">
						<option value="">All</option>
			...
			<div class=" col-xs-12 padfive full_smal_tab">
				<div class="lablform">&nbsp;</div>
				<div class="searchsbmtfot searchbtn">
					<input type="submit" class="searchsbmt searchbtn_inpt" value="search" />
				</div>
			</div>
	</div>
</form>