...
?></strong></td>
            ...
            <tr>
                ...
                <td style="padding:10px 0; padding-left: 10%; line-height:25px;"><span style="font-size:14px;">Customer Support</span><br><span><img style="vertical-align:middle" src="<?= SYSTEM_IMAGE_DIR . 'phone.png' ?>" /> <span style="font-size:16px;color:#00a9d6;vertical-align:middle;font-weight: 600;"> &nbsp;<?php echo $customer_support ?></span></span></td>
...
<?php endif; ?>
 <tr>
                                                    <td><span>Convenience</span></td>
                                                    <td><span> <?php echo number_format($booking_details['convinence_amount'], 2) ?></span></td>
                                                </tr>
<?php if ($GST > 0) { ?>
                                                <tr>
                                                    <td><span>GST</span></td>
