...
Class Hotel_Model extends CI_Model
{
	...
	/*function get_hotel_city_list($search_chars)
	{
		...
		$query = 'Select * from all_api_hotel_cities as cm where  cm.city_name like '.$search_chars.' 
	...
	{
		//debug($temp_search_data);die('$temp_search_data');
		$success = true;
		// echo "dszfds";
	...
	$hotel_check_in, $hotel_check_out, $payment_mode,	$attributes, $created_by_id, $transaction_currency, $currency_conversion_rate, $phone_code)
	{
		...
		// Add default value for PDO connection
		$data['promo_code'] = '';
		$data['discount'] = 0;
		$data['hb_supplier_code'] = '';
		$data['hb_vat_number'] = '';
		$data['booking_billing_type'] = '';
		$data['booked_by'] = $created_by_id;
