    ...
    function _executeLazy(instance, configuration, items, events)
    {
        ...
        function _initialize()
        {
            ...
            if( configuration("delay") < 0 || configuration("combined") )
            {
                ...
                //Balu A Modified - Helpfull for ajax loaded contents
                $(document).on("scroll." + instance.name + " resize." + instance.name, configuration("appendScroll"), events.e);
            }
        }
        ...
        (function()
        {
            ...
            //Balu A
            //set global mutator observer for lazy load to be triggered
        	$(_lazy_content).ajaxComplete(_initialize());
        })();
    }
