...
$(document).ready(function() {
   $(".first_name").keypress("keyup blur change focus", function(event) {
    ...
    $('.office_phone').keypress("keyup blur change focus", function(event) {
        if (this.value != '' || this.value != null) {
           // $(this).val($(this).val().replace(/[^-?][^0-9.]/, ''));
           var keycode = event.which;
        if (!(event.shiftKey == false && (keycode == 46 || keycode == 8 || keycode == 37 || keycode == 39 || (keycode >= 48 && keycode <= 57)))) {
    ...
    $('.gst_phone').keypress("keyup blur change focus", function(event) {
        if (this.value != '' || this.value != null) {
           // $(this).val($(this).val().replace(/[^-?][^0-9.]/, ''));
           var keycode = event.which;
        if (!(event.shiftKey == false && (keycode == 46 || keycode == 8 || keycode == 37 || keycode == 39 || (keycode >= 48 && keycode <= 57)))) {
    ...
    $('#pan_number').keypress("keyup blur change focus", function(event) {
        if (this.value != '' || this.value != null) {
           // $(this).val($(this).val().replace(/[^-?][^0-9.]/, ''));
           var keycode = event.which;
        if (!(event.shiftKey == false && (keycode == 46 || keycode == 8 || keycode == 37 || keycode == 39 || (keycode >= 48 && keycode <= 57)))) {
