            ...
            if(valid_array($v['Fares'])){
                ...
                foreach ($legs as $l_k => $l_v) {
                    // foreach($fares_data as $fare_key => $fares_value){
                        ...
                        $stop_over ='';
                        $details[] = $this->format_summary_array($journey_number, $origin_code, $destination_code, $departure_dt, $arrival_dt, $operator_code, $operator_name, $flight_number, $no_of_stops, $cabin_class, '', '', $total_duration, $is_leg, $attr, $stop_over);
