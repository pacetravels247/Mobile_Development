...
INR") {
    ...
    public function get_extra_services($request,$farequote_data, $search_id) {
        ...
        $ssr_response_xml = $this->process_request(trim($ssr_request ['request'][0]), $ssr_request ['url'],  $ssr_request ['SOAPAction'], $ssr_request ['remarks']);
...
// 
    ...
    */
    ...
    function process_request($request, $url, $soapaction, $remarks = '') {
        ...
        $insert_id = $this->CI->api_model->store_api_request($url, serialized_data($request), $remarks);
          // echo $request;exit;
