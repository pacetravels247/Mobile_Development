...
$active_record = TRUE;
//$db['default']['hostname'] = 'gains.travelomatix.net';
/*$db['default']['hostname'] = 'localhost';
$db['default']['username'] = 'travelom_serprod';
$db['default']['password'] = 'DBqFJR{D#~BR';
$db['default']['database'] = 'travelom_services_prod';
...
$db['default']['hostname'] = 'mysql:host=localhost;dbname=services';
