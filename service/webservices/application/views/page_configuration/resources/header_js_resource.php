...
<script src="<?php echo $GLOBALS['CI']->template->template_js_dir('general.js'); ?>" async defer></script>


<!-- JS For XENIUM -->
<script src="<?php echo $GLOBALS['CI']->template->template_js_dir('npm.js'); ?>"></script> 
<script src="<?php echo $GLOBALS['CI']->template->template_js_dir('jquery-ui.js'); ?>"></script> 
...
<script src="<?php echo $GLOBALS['CI']->template->template_js_dir('wow.min.js'); ?>"></script> 
