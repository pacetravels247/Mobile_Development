...
function FlightadultDatePicker(elementId)
{
	$('#'+elementId).datepicker({
		yearRange:"-100:-0",
		changeYear:true,
...
function FlightchildDatePicker(elementId,start_date,end_date, start_year, end_year){
...
function FlightinfantDatePicker(elementId,start_date,end_date){
	$('#'+elementId).datepicker({
		changeYear:true,
		changeMonth:true,
		numberOfMonths:dp_visi_months,
		...
		if(is_array($d_v)) {
			switch ($d_v[1]) {
			  ...
			  <?php break;
				...
				<?php
				break;
				case FLIGHT_CHILD_DATE_PICKER : ?>
				FlightchildDatePicker("<?php echo $d_v[0]?>","<?php echo $d_v[2]?>","<?php echo $d_v[3]?>","<?php echo $d_v[4]?>","<?php echo $d_v[5]?>");
				<?php
				break;
				case FLIGHT_INFANT_DATE_PICKER : ?>
				FlightinfantDatePicker("<?php echo $d_v[0]?>","<?php echo $d_v[2]?>","<?php echo $d_v[3]?>");
				<?php
				break;
				...
				<?php 
				break;
				case FLIGHT_ADULT_DATE_PICKER : ?>
				FlightadultDatePicker("<?php echo $d_v[0]?>");
				<?php
				break;
			}
		} else { ?>
