...
<html>
	<body>
		...
		<?php } ?>
		<table cellspacing="0" cellpadding="0" border="0" style="border: 2px solid #eeeeee; background: #ffffff; font-size: 14px;  width: 100%; max-width: 600px; margin: 0px auto; font-family: cambria,serif; color:#222;">
			<tbody>
				<tr>
					<td width="45%">
						<img src="<?php echo SYSTEM_IMAGE_FULL_PATH_TO_EXTRA.$GLOBALS['CI']->template->domain_images($GLOBALS['CI']->application_domain_logo); ?>" alt="logo">
					</td>
					<td width="55%"> <h2 style="font-size: 14px; font-weight:600;text-align: left;color: #ff0000;"><?= $tour_data['package_name']; ?></h2>
						  <span style="font-size: 13px;text-align: left;"><?=($tour_data['duration']+1);?> Days / <?=$tour_data['duration'].(($tour_data['duration']==1)? 'Night': 'Nights');?> </span>
						  
					</td>
                </tr>
                <tr><td colspan="2" style="border-bottom: 2px solid #eee"></td>&nbsp;</tr>
				<tr><td></td>&nbsp;</tr>
                <tr>
					<td colspan="2" style="margin-left: auto;margin-right: auto;text-align: center;">
					  <span style="width:100%; float:left"><img  style="width: 500px;height: 150px;" src="<?=SYSTEM_IMAGE_FULL_PATH_TO_EXTRA.$this->template->domain_images($tour_data['banner_image']);?>" alt="img" /></span>
					</td>
                </tr>
				<?php 
                ...
                ?>
                        ...
                        <?php 
                           ...
                           ?>
                        <tr>
                           <td colspan="2"  style="margin: 0 auto;text-align:center;font-size: 12px;font-weight:600;">
                              <span>
                                 <?php 
                              ...
                              <span style="color: #018798;">Departure Dates</span><br>
                               <span>
                                 <?php 
                                    if($tour_data['package_type']=="fit"){
                       ...
                       <!--  <tr>
                        ...
                        <!--<tr>
                           <td style="padding:0px 10px 10px 0">
                             <h2 style="margin: 5px 0 2px;font-size: 14px;font-weight:600;">TYPE</h2>
                             <p style="">
                               <?php
                        ...
                        <!--  <tr>
                           <td style="padding:0px 10px 10px 0">
                             <h2 style="margin: 5px 0 2px;font-size: 14px;font-weight:600;">Activities</h2>
                             <p style="">
                               <?php 
                        ...
                        <tr>
                           <td colspan="2">
                              ...
                              <span style="text-align: left;font-size: 15px;font-weight: 600;border-bottom: 1px solid #ccc;color: #018798;">Detailed Itinerary</span><br>
                        ...
                        <tr>
                           <td colspan="2">
                              <span style="font-weight:bold">Day <?php echo $key+1; ?> - <?php echo  $itinary['visited_city_name']; ?> </span><br>
                              <span>
                              ...
                              <span style="font-weight:bold">Meal Plan:
                          ...
                          <tr><td colspan="2" style="display:inline-block;margin-left: auto;margin-right: auto;text-align: center;">
                              <?php $imag_array= explode(',',$itinary['banner_image']);
                                 foreach($imag_array as $im){
                                   if($im!=''){
                                 echo '<img style="width:150px;height:150px;border:3x solid #fff;" src="'.$this->template->domain_images($im).'">';
                                   }
                                 }
                        ...
                        <tr>
                           <td colspan="2">
                              <p>
                              <h1 style="text-align:center;font-size: 15px;font-weight:600;"><em>Tour Ends with Sweet Memories’…….</em></h1>
                              </p>
                           </td>
                        </tr>
                        <tr>
                           <td colspan="2">
                              <p>
                              <h1 style="text-align:left;font-size: 12px;font-weight:600;color: #018798;">Detailed Holiday Price: B2B Pricing</h1>
                              </p>
                              <ul>
                              ...
                              <table class="tabel table-bordered" cellpadding="8" border="1" style="margin-right: auto;margin-left: auto;border:1px solid #ccc;">
                                 <tr>
                        ...
                        <!--  <tr>
                           <td style="padding:0px 10px 10px 0">
                             <h2 style="margin:5px 0;font-size: 14px; font-weight:600">B2B TOUR COST</h2>
                             <?php
                              $arr_occ = array();
                           ...
                           <tr>
                           <td style="padding:0px 10px 10px 0">
                             <h2 style="margin:5px 0;font-size: 14px; font-weight:600">B2C TOUR COST</h2>
                             <?php
                              $arr_occ = array();
                           ...
                           <!--  <tr>
                               <td style="padding:0px 10px 10px 0">
                                 <h2 style="margin:5px 0;font-size: 14px; font-weight:600">TOUR COST</h2>
                                 <?php 
                              $arr_occ = array();
                        ...
                        <tr>
                           <td colspan="2" style="border-bottom: 2px solid #eeeeee;">
                              <h2 style="font-size: 12px; font-weight:600;color: #018798;">ACCOMMODATION</h2>
                        ...
                        <tr>
                           <td colspan="2" style="border-bottom: 2px solid #eeeeee;">
                              <h2 style="font-size: 12px; font-weight:600;color: #018798;">PACKAGE PRICE INCLUDES:</h2>
                              <p>
                                 <?php 
                        ...
                        <tr>
                           <td colspan="2" style="border-bottom: 2px solid #eeeeee;">
                              <h2 style="font-size: 12px; font-weight:600;color: #018798;">PACKAGE PRICE DOES NOT INCLUDES:</h2>
                              <p>
                                 <?php 
                        ...
                        <tr>
                           <td colspan="2" style="border-bottom: 2px solid #eeeeee;">
                              <h2 style="font-size: 12px; font-weight:600;color: #018798;"> GENERAL CONDITIONS & REMARKS:</h2>
                              <p style="white-space: normal;">
                                 <?php
                        ...
                        <tr style="border-bottom: 2px solid #eeeeee;">
                           <td colspan="2">
                              <h1 style="font-size: 12px; font-weight:600;color: #018798;">TRIP NOTE:</h1>
                              <p style="white-space: normal;">
                                 <?php $tours_itinerary['trip_notes'] = str_replace('\n', '', $tour_data['trip_notes']);
                                    echo htmlspecialchars_decode($tours_itinerary['trip_notes']); ?>
                              </p>
                           </td>
                        </tr>
                        <tr>
                           <td colspan="2">
                              <h1 style="font-size: 12px; font-weight:600;color: #018798;">VISA PROCEDURES</h1>
                              <p style="white-space: normal;">
                                 <?php $tours_itinerary['visa_procedures'] = str_replace('\n', '', $tour_data['visa_procedures']);
                                    echo htmlspecialchars_decode($tours_itinerary['visa_procedures']); ?>
                              </p>
                           </td>
                        </tr>
                        <!-- <tr style="border-bottom: 2px solid #eeeeee;">
                        ...
                        <tr>
                           <td colspan="2">
                              <h1 style="font-size: 12px; font-weight:600;color: #018798;">PAYMENT POLICY:</h1>
                              <p style="white-space: normal;">
                                 <?php $tour_data['b2b_payment_policy'] = str_replace('\n', '', $tour_data['b2b_payment_policy']);
                                    echo htmlspecialchars_decode($tour_data['b2b_payment_policy']); ?>
                              </p>
                           </td>
                        </tr>
                        <tr>
                           <td colspan="2">
                              <h1 style="font-size: 12px; font-weight:600;color: #018798;">CANCELLATION POLICY:</h1>
                              <p style="white-space: normal;">
