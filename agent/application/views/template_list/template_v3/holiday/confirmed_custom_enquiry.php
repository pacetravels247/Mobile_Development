					...
					<table class="table table-condensed table-bordered rigid_actions" id="b2b_report_hotel_table">
						...
						//debug($tours_enquiry);
							...
							foreach($tours_enquiry as $parent_k => $parent_v) {
								...
								echo $GLOBALS['CI']->template->isolated_view('holiday/enq_upload_details',$parent_v);
								echo $GLOBALS['CI']->template->isolated_view('report/enq_payment_details',$parent_v);
								//debug($parent_v);
								extract($parent_v);
						...
						?>
							...
							<tr class="enq_tr">
								...
								<td>
									...
									<a class="btn btn_sm" data-toggle="modal" data-target="#upload_details_<?=$enquiry_reference_no?>" target="_blank" >Downloads</a><br>  
								</td>
								</tr>
								<?php	
								}
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="#" enctype="multipart/form-data" method="post" id="upload_<?=$data['id']?>"> 
