...
//print_r($count);
            ...
            $duration = $d;
				...
				$origin_terminal = '';
				$dest_terminal = '';
				if($__segment_v['OriginDetails']['OriginTerminal'] !=''){
					$origin_terminal = 'Terminal : '.$__segment_v['OriginDetails']['OriginTerminal'];
				}
				if($__segment_v['DestinationDetails']['DestinationTerminal'] !=''){
					$dest_terminal = 'Terminal : '.$__segment_v['DestinationDetails']['DestinationTerminal'];
				}
				...
				$outer_summary .= '<div class="allsegments outer-segment-'.$__segment_k.'">';
					...
					$outer_summary .= '<div class="quarter_wdth nopad ' . add_special_class('col-xs-3', 'col-xs-3', $domestic_round_way_flight) . '">
										...
										<div class="m-b-0 text-center">
											...
											<br><strong> '.$__segment_v['AirlineDetails']['AirlineCode'].' '.$__segment_v['AirlineDetails']['FlightNumber'].'</strong>
											<br/>'.$cabin_class.'
										</div>
									  </div>';
					//depart
