	...
	<?php echo $this->session->flashdata("msg"); ?>
     ...
     <form autocomplete="off" name="flight_group_request" id="flight_group_request" action="<?php echo base_url()."index.php/general/save_group_request"?>" method="post" class="activeForm oneway_frm" style="">
	         ...
	         <div class="col-md-12 padfive placerows">
	            <div class="col-xs-3">
	              <!--  <div class="col-xs-12 padfive"></div> -->
		               <div class="col-xs-12 padfive"> <div class="plcetogo deprtures sidebord">
		               	<div class="lablform txtclr">From</div>
	            ...
	            <div class="col-xs-3">
	              <!--   <div class="col-xs-12 padfive"> </div> -->
	                <div class="col-xs-12 padfive">
		                <div class="plcetogo destinatios sidebord">
		                	<div class="lablform txtclr">To</div>
	             ...
	             <!--   <div class="col-xs-12 padfive"></div> -->
	              ...
	              <!-- class="plcetogo datemark sidebord"<input readonly="" class="normalinput auto-focus hand-cursor form-control b-r-0 hasDatepicker" id="flight_datepicker1" placeholder="Select Date" value="" name="depature" required="" enabled="enabled" type="text">-->
	               <div class="lablform txtclr">Departure</div>
	            ...
	            <!--     <div class="col-xs-12 padfive"><div class="lablform txtclr">Return</div></div> -->
	                <div class="col-xs-12 padfive">
		                <div class="datemark">
		                	<div class="lablform txtclr">Return</div>
	            ...
	            <div class="roomrow">
	                           ...
	                           <div class="col-xs-12 nopad">
	                              <div class="input-group pax-count-wrapper adult_count_div">
	                               <input name="adult_num" class="normalinput adt auto-focus valid_class form-control b-r-0 invalid-ip numeric" id="adult" placeholder="" required="" type="text" maxlength="2">
	                               <span id="error_msg_adult_count" style="display: none;color:red;"></span>
	               ...
	               <div class="col-xs-2">
	                  <div class="roomrow">
	                           ...
	                           <div class="col-xs-12 nopad">
	                              <div class="input-group pax-count-wrapper child_count_div">
	                               ...
	                               <input name="child_num" class="normalinput adt form-control b-r-0 numeric" id="child" placeholder="" type="text" maxlength="2"> 
	                ...
	                <div class="col-xs-2">
	                           ...
	                           <div class="col-xs-12 nopad">
	                              ...
	                              <input name="infant_num" class="normalinput adt form-control b-r-0 numeric" id="infant" placeholder="" type="text" maxlength="2"> 
	              ...
	              <div class="col-xs-3 mbl">
	               ...
	               <input name="curncy" class="normalinput padL5 form-control b-r-0 " placeholder="" required="" value="<?=$currency?>" type="text" readonly="" style="background-color: #f2f2f2!important;padding-left: 20px;border-right: 0!important;">
	               ...
	               <input name="fare" class="normalinput passenger_fare  form-control b-r-0 " id="fare" placeholder="" required="" type="text" maxlength="12"></div>
	            	...
	            	<span id="error_msg_fare_pre_num" style="display: none;color:red;"></span>
                       ...
                       <div class="col-md-12 padfive placerows id-pas-details">
		                       	<div class="col-md-3">
				            ...
				            <span id="error_msg_eemail" style="display: none;color:red;"></span></div>
				             ...
				             <div class="col-md-3">
				               <div style="width:100%;" class="plcetogo  sidebord1">
	...
	$('[type="submit"]').on('click', function(event) {
	   ...
	   if(total_pax<10){
		...
		if(adult_count == ""){
			...
			$('#error_msg_adult_count').show();
			$('#error_msg_adult_count').text("Please enter expected adult count.");
		 	return false;
		}else{
			$('#error_msg_adult_count').hide();
		}
...
.deprtures::before, .destinatios::before, .datemark::before {
    color: #a05f03;
    top: 18px;
}
    ...
    .id-pas-details .normalinput {
    	padding: 15px;
    }
    input#from, input#to, input#flight_datepicker1, input#flight_datepicker2, .normalinput {
    	border-radius: 4px!important;
    }
    .b-r-0 {
    	border-radius: 4px !important;
    ...
    .logo-lg img.img-responsive.center-block {
    	width: 50px!important;
    }
    @media(max-width: 550px)
    {
    	form#flight_group_request #onw_rndw_fieldset .placerows
    	{
    		float: left;
    width: 100%;
    margin: 20px 0px;
    	}
    	.col-md-12.padfive.placerows .col-xs-3 {
    width: 50%;
    padding: 10px 0px;
}
.backshadow .lablform {
...
.plcetogo.sidebord1 .lablform.txtclr1 {
    margin-top: -17px !important;
}
.col-md-12.padfive.placerows .col-xs-2 {
    width: 33.33%;
}
.col-md-12.padfive.placerows .col-xs-3.mbl {
    width: 100%;
    margin: 20px 0px;
}
.sidebord1 {
...
.col-md-12.padfive.placerows .col-xs-3.mbl .col-xs-9.nopad {
    width: 60%;
    float: left;
    margin-top: -10px;
}
.col-md-12.padfive.placerows .col-xs-3.mbl .col-xs-3.nopad {
    width: 40%;
    float: left;
}
.id-pas-details {
...
.id-pas-details .col-md-3.pull-right {
    width: 100%;
}
.searchsbmtfot {
    line-height: 45px;
