...
<div class"col-md-12">
	...
	<div class="panel-body">
		...
		<div class="list-group">
			...
			<a href="<?php echo base_url('voucher/bus/'.$app_reference . '/' . $booking_source.'/BOOKING_CANCELLED/send_credit_note/0/0/'.$agent_refund_amount.'/'.$agent_cancellation_charge.'?passenger_origin='.@$_GET["passenger_origin"]); ?>">View Your Credit Note</a></p> 
			<p class="list-group-item">
			...
			<p class="list-group-item">
			<a href="<?php echo base_url('voucher/bus/'.$app_reference . '/' . $booking_source.'/BOOKING_CANCELLED/send_credit_note/0/1/'.$agent_refund_amount.'/'.$agent_cancellation_charge.'?passenger_origin='.@$_GET["passenger_origin"]); ?>">Email & SMS your Credit Note</a></p>
			<p class="list-group-item">
