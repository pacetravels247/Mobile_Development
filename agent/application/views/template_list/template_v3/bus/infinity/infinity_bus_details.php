...
require_once 'infinity_seat_layout.php';
//echo '<hr>';
?>
    ...
    <div class="col-xs-12 col-md-2">
        <div class="butonconty">
            <form class="booking-form" action="<?=base_url().'index.php/bus/booking/'.$search_id?>" method="POST" target="">
                ...
                <input type="hidden" name="reference_number" class="route-schedule-id" value="<?=$CUR_Route['ReferenceNumber']?>">
                ...
                <input type="hidden" name="booking_source" class="booking-source" value="<?=INFINITY_BUS_BOOKING_SOURCE?>">
