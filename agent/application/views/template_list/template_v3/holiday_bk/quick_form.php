<div class="container"><div class="quick_form">
	...
	<div class="qfagnt_detail">
		<span>Agent Id:	<input type="text" class="form-control" value="<?=$agent_name?>" readonly name="agent_name"></span><br>
		<span>Agent Name: 	<input type="text" class="form-control" value="<?=$agent_id?>" readonly name="agent_id"></span>
	</div>
	<!--  -->
