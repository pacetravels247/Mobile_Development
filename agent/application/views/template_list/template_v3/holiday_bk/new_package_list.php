  ...
  <div class="col-md-12">
    <div class="row">
      ...
      <div class="col-sm-12">
		...
		?>
        <div class="row id-p-search-row each_package sort_sight_divs" data-sort="<?=$pack_val['netprice_price']?>" data-sort_duration="<?=$pack_val['duration']?>">
      ...
      <div class="modal fade" id="enquiry_form_<?=$pack_val['pack_id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <form action="<?php echo base_url();?>index.php/tours/send_enquiry" method="post" >
            <div class="col-md-10 col-md-offset-1 holiday_srch_input">
            <input type="hidden"  name="pack_id"  value="<?=$pack_val['pack_id']?>">
            <input type="hidden"  name="pack_name"  value="<?=$pack_val['package_name']?>">
             ...
             <div class="form-group">
              ...
              <input type="date" class="form-control" value="" name="dep_date">
             </div>
