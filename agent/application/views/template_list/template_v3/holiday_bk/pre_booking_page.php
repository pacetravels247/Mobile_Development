	...
	<div class="col-md-12">
		<div class="id-main-optional-div">
			<form action="<?php echo base_url();?>index.php/tours/pre_booking" method="post" id="send_booking">
				...
				<div class="row id-optional-table">
					...
					<table class="table " >
						...
						?>
								<tr>
									<td><?=$i?></td>
									<td><?=number_format($adult_cal_price,2)?> x <?=$adult[$i-1]?></td>
									<td><?=number_format($package_price_details[11]['netprice_price']+$agent_markup,0)?> x <?=$child_with_bed[$i-1]?></td>
									<td><?=number_format($package_price_details[12]['netprice_price']+$agent_markup,0)?> x <?=$child_without_bed[$i-1]?></td>
									<td><?=number_format($package_price_details[13]['netprice_price']+$agent_markup,0)?> x<?=$infant[$i-1]?></td>
								</tr>
						<?php		
				...
				<input type="hidden" class="paid" name="paid" value="<?=$b2b_adv_amount?>">
						...
						<div class="row">
							...
							<div class="col-sm-4 padfive">
								<div class="id-pay-div">
									<label for="pay1">
									<input type="radio" id="pay1" name="pay1" value="advance_pay" class="id-optional-check" checked="checked" data-amount="<?=$b2b_adv_amount?>">
							...
							<div class="col-sm-4 padfive">
								<div class="id-pay-div">
									<label for="pay2">
									<input type="radio" id="pay2" value="full_pay" name="pay1" class="id-optional-check" data-amount="<?=$total_trip_with_gst_cost?>">
							...
							<div class="col-sm-4 padfive">
								<div class="id-pay-div">
									<label for="pay3">
									<input type="radio" id="pay3" value="wish_pay" name="pay1" class="id-optional-check wish_pay">
