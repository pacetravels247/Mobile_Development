...
$agent_markup = $itinerary_details_details["agent_markup"];
...
<div class"col-md-12">
	...
	<div class="panel-body">
		...
		<div class="list-group">
			...
			<a href="<?php echo base_url('voucher/hotel/'.$app_reference . '/' . $booking_source.'/BOOKING_CANCELLED/send_credit_note/0/0/'.$agent_refund_amount.'/'.$agent_cancellation_charge); ?>">View Your Credit Note</a></p> 
			<p class="list-group-item">
			<a href="<?php echo base_url('voucher/hotel/'.$app_reference . '/' . $booking_source.'/BOOKING_CANCELLED/send_credit_note/0/0/'.$customer_refund_amount.'/'.$agent_cancellation_charge.'/1'); ?>">View Customer Credit Note</a></p> 
			<p class="list-group-item">
			<a href="<?php echo base_url('voucher/hotel/'.$app_reference . '/' . $booking_source.'/BOOKING_CANCELLED/send_credit_note/0/1/'.$agent_refund_amount.'/'.$agent_cancellation_charge); ?>">Email & SMS your Credit Note</a></p>
			<p class="list-group-item">
			<a href="<?php echo base_url('voucher/hotel/'.$app_reference . '/' . $booking_source.'/BOOKING_CANCELLED/send_credit_note/0/1/'.$customer_refund_amount.'/'.$agent_cancellation_charge.'/1'); ?>">Email & SMS Customer Credit Note</a></p>
			<?php } ?>
		</div>
		</div> 
	</div>
