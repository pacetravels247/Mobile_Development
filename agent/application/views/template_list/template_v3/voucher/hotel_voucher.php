...
$logo = '';
 //echo $booking_details['hotel_image'];exit;
if(isset($booking_details['user_image'])){
   $logo = $booking_details['user_image'];
}else{
   $logo = $booking_details['domain_logo'];
}
?>
<div style="width:100%; position:relative" id="ticket_hotel">
   <table cellpadding="0" cellspacing="0" width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif; width:900px; margin:0px auto;background-color:#fff; padding:50px 45px;">
      <tbody>
         <tr>
            <td style="border-collapse: collapse; padding:35px;" >
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                           ...
                           <tr>
                              <td>
                                 <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                       <td style="padding: 0px;" class="voucher_logo"><img src="<?=$GLOBALS['CI']->template->domain_images($logo)?>" style="width: 100px;"></td>
                                       <td style="padding: 0px;">
                                          <table width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif;border-collapse: collapse;text-align: right; line-height:15px;" cellpadding="0" cellspacing="0" border="0">
                                             <tr>
                                                <td colspan="4" align="right" style="padding-top:10px;font-size:13px;line-height:20px;"><?=$data['domainname']?><br>ContactNo :<?=$data['country_code']?> <?=$data['phone']?><br><?=$data['address']?><br></td>
                                             </tr>
                                             <tr>
                                                <td style="padding-bottom:10px;line-height:20px" align="right"><span>Booked Date : <?php echo date("d M Y",strtotime($booking_details['created_datetime'])); ?></span></td>
                                             </tr>
                                          </table>
                                       </td>
                                    </tr>
                           ...
                           <tr>
                              <td>
                                 <table width="100%" style="line-height:24px;font-size:13px;border-top:1px solid #00a9d6;border-bottom:1px solid #00a9d6;padding: 5px;">
                                    <tr>
                                       <td style="padding: 0px;">
                                          <table width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif;border-collapse: collapse;text-align: left; line-height:15px;" cellpadding="0" cellspacing="0" border="0">
                                             <!-- <tr>
                                                <td style="font-size:14px;"><span style="width:100%; float:left"><?php echo $data['address'];?></span></td>
                                                </tr> -->
                                             <tr>
                                                <td style="padding:10px 0;line-height:20px"><span>Booking Reference: <?php echo $booking_details['app_reference']; ?></span><br></td>
                                             </tr>
                                          </table>
                                       </td>
                                       <td align="right" style="line-height:24px;font-size:13px;padding: 5px;">Status: <strong class="<?php echo booking_status_label( $booking_details['status']);?>" style=" font-size:14px;">
                                          <?php 
                              ...
                              <td>
                                 <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;padding:5px;">
                                    ...
                                    <tr>
                                       ...
                                       <td width="32%" style="padding:10px 0;text-align: center;"><span style="font-size:15px; border:2px solid #808080; display:block"><span style="color:#00a9d6;padding:5px; display:block;text-transform:uppercase">Booking ID</span><span style="font-size:18px;line-height:35px;padding-bottom: 5px;display:block;font-weight: 600;"><?php echo $booking_details['booking_id']; ?></span></span></td>
                                    </tr>
                                    </tbody>
                                 </table>
                              </td>
                     ...
                     <!-- <tr>
                        <td colspan="4" align="right" style="padding-top:10px;font-size:13px;line-height:20px;"><?=$data['domainname']?><br>ContactNo :<?=$data['country_code']?> <?=$data['phone']?><br><?=$data['address']?></td>
                           ...
                           <?php
                              ...
                              ?>
                                  <tr>
                                      <td colspan="4" style="padding-top:10%;width:100%">
                                          <img src="<?=$this->template->domain_images().'offer_images/'.$adv_data[0]['image']?>" height="20%" width="100%">
                                      </td>
                                  </tr>
                              <?php } ?>
                        </table>
   ...
   <table id="printOption"onclick="w=window.open();w.document.write(document.getElementById('ticket_hotel').innerHTML);w.print();w.close(); return true;"
...
<script type="text/javascript">
   $('#addMarkup').click(function(){
      ...
      $.ajax({
         url:app_base_url+'index.php/voucher/hotel_voucher_add_markup',
         type:'POST',
