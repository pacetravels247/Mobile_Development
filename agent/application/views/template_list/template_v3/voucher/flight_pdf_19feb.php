...
<div style="background:#ccc; width:100%; position:relative">
    <table cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:9pt;font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
        <tbody>
            <tr>
                <td colspan="2" valign="bottom" style="padding-bottom:10px;" class="voucher_logo"><img style="width: 80px;" src="<?= $GLOBALS['CI']->template->domain_full_images($data['logo']) ?>" /></td>
                <td valign="bottom" colspan="2" style="padding-bottom:10px" align="right">
            ...
            <tr>
                <td colspan="4" style="padding:0;">
                    <table border="0" cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #00a9d6;font-size:9pt; padding:0;">
                        <tbody>
                            <tr>
                                <td colspan="2" style="background-color:#00a9d6; color:#fff"><img width="9" src="<?= FULL_SYSTEM_IMAGE_DIR . 'flight.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Onward Flight Details</span></td>                
            ...
            <tr>
                <td colspan="4" style="padding:0;">
                    <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #666666;font-size:9pt; padding:0;">
                        <tbody>
                            <tr>
                                <td colspan="4" style="background-color:#666666; color:#fff"><img width="12" style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'people_group.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Passenger(s) Details</span></td>
                            </tr>
                            <tr>
