...
<table cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:12px; font-family: 'Open Sans', sans-serif; width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000; border: 2px solid;">
<tbody>
...
<tbody>
<tr>
    <td colspan="5" style="background-color:#666666; color:#fff"><img style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'people_group.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:16px"><strong>Passenger(s) Details</strong></span></td>
</tr>
<tr>
...
# Checking Cabin Baggage
        ...
        if (is_int($segment_details_v['cabin_baggage'])) {
        	...
        	if(empty($segment_details_v['cabin_baggage']) == false){
...
<tr>
<td align="right" colspan="4" style="line-height:26px; border-top:1px solid #800000; border-bottom:1px solid #800000;"><span style="font-size:12px;">Status: </span><strong class="<?php echo booking_status_label($booking_transaction_details[0]['status']) ?>" style=" font-size:14px;">
<?php
switch (@$booking_transaction_details[0] ['status']) {
case 'BOOKING_CONFIRMED' :
echo 'CONFIRMED';
...
<tbody>
    <tr style="border-bottom:2px solid;">
        <td colspan="5" style="background-color:#800000; color:#fff"><img style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'people_group.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:16px;">Passenger(s) Details</span></td>
    </tr>
