                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                           ...
                           <tr>
                              <td>
                                 <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                       <td style="padding: 0px;" class="voucher_logo"><img src="<?=$GLOBALS['CI']->template->domain_full_images($logo)?>" style=" width: 100px;"></td>
                                       <td style="padding: 0px;">
                                          <table width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif;border-collapse: collapse;text-align: right; line-height:15px;" cellpadding="0" cellspacing="0" border="0">
                                             <tr>
                                                <td colspan="4" align="right" style="padding-top:10px;font-size:13px;line-height:20px;"><?=$data['domainname']?><br>ContactNo :<?=$data['country_code']?> <?=$data['phone']?><br><?=$data['address']?><br><br></td>
                                             </tr>
                                             <tr>
                           ...
                           <tr><td style="line-height:12px;">&nbsp;</td></tr>      
                           <tr>
                              <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=FULL_SYSTEM_IMAGE_DIR.'hotel_v.png'?>" /> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Hotel Details</span></td>
                           </tr>
                           <tr>
                           ...
                           <tr><td style="line-height:12px;">&nbsp;</td></tr>
                           <tr>
                              <td style="background-color:#666666;border: 1px solid #666666; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=FULL_SYSTEM_IMAGE_DIR.'people_group.png'?>" /> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Guest(s) Details</span></td>
                           </tr>
                           <tr>
                              ...
                              ?>
                                  <tr>
                                      <td colspan="4" style="padding-top:10%;width:100%">
                                          <img src="<?=$this->template->domain_full_images().'offer_images/'.$adv_data[0]['image']?>" height="20%" width="100%">
                                      </td>
                                  </tr>
                              <?php } ?>
                        </table>
