...
<table class="main" cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:12px; font-family: 'Open Sans', sans-serif; width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000; border: 2px solid;">
<tbody>

<tr>
<td colspan="2" style="padding-bottom:10px" class="voucher_logo"><img src="<?= $GLOBALS['CI']->template->domain_full_images($data['logo']) ?>" style="width: 100px;"/></td>
<td colspan="2" style="padding-bottom:10px" align="right">

<h4 style="font-size:16px;color:#800000;vertical-align:middle;font-weight: 600;">Agency Info</h4>
...
<td align="right" colspan="2" style="line-height:26px; border-top:1px solid #800000; border-bottom:1px solid #800000;"><span style="font-size:12px;">Status: </span><strong class="<?php echo booking_status_label($booking_transaction_details[0]['status']) ?>" style=" font-size:14px;">
<?php
...
<?php } ?>
<tr>
<td style="padding:10px 0"><img style="width:60px;" src="<?= FULL_SYSTEM_IMAGE_DIR . 'airline_logo/' . $itinerary_details[0]['airline_code'] . '.gif' ?>" /></td>
...
<td style="padding:10px 0; padding-left: 5%; line-height:25px;"><span style="font-size:14px;">Agency</span><br><span><img style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'phone.png' ?>" /> <span style="font-size:16px;color:#800000;vertical-align:middle;font-weight: 600;"> &nbsp;<?php echo $data['phone'] ?></span></span></td>
...
<?php if ($booking_transaction_details[0] ['status'] == 'BOOKING_CONFIRMED' || $booking_transaction_details[0] ['status'] == 'BOOKING_HOLD') { ?>
    <span style="color:#800000;padding:5px; display:block"><strong>AIRLINE PNR<strong></span>
    <span style="font-size:26px;line-height:35px;padding-bottom: 5px;display:block;font-weight: 600; border-bottom: 1px solid #800000;"><?= @$airline_pnr ?></span>
<?php } ?>
...
<tr style="border-bottom:2px solid;">
    <td colspan="5" style="background-color:#800000; color:#fff"><img style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'people_group.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:16px"><strong>Passenger(s) Details</strong></span></td>
</tr>
<tr>
    <td style="background-color:#d9d9d9; color:#800000"><span>Sr No.</span></td>
    ...
    <td style="background-color:#d9d9d9; color:#800000"><span>Ticket Status</span></td>
</tr>
<?php
$booking_transaction_details_value = $booking_transaction_details [0];
// debug($booking_transaction_details_value);exit;
...
<tbody>
<tr style="border-bottom:2px solid;">
    <td colspan="2" style="background-color:#800000; color:#fff"><img style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'flight.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:16px"><strong>Onward Flight Details</strong></span></td>
    <td align="right" colspan="2" style="background-color:#800000; color:#fff"><span style="font-size:10px">*Please verify flight times with the airlines prior to departure</span></td>
</tr>
<?php
...
?>
            <tr>
                <td colspan="2" style="background-color:#800000; color:#fff"><img style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'flight.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:13px">Return Flight Details</span></td>
                <td align="right" colspan="2" style="background-color:#800000; color:#fff"><span style="font-size:10px">*Please verify flight times with the airlines prior to departure</span></td>
            </tr>
        ...
        if (valid_array($segment_details_v) == true) {
            ...
            <tr>
                ...
                <!-- <td><span style="display:block;border-left: 1px solid #999; padding-left:10%"><?php echo $non_stop; //echo " | ".$segment_details_v['total_duration']; ?><br><?php echo $segment_details_v['is_refundable'];
                 ?></span></td> -->
                 <td><span style="display:block;border-left: 1px solid #999; padding-left:10%"><?php echo $non_stop; echo " | ".$segment_details_v['total_duration']; ?></span></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td colspan="3">
...
?>
                            <tr><td colspan="4" style="background-color:#d9d9d9; color:#800000"><span><?php echo 'Extra Baggage Information'; ?> ( <?= $bag_lv ?> )</span></td></tr>
            <?php
            foreach ($baggage_details['details'] as $bag_k => $bag_v) {
                foreach ($bag_v as $bd_k => $bd_v) {
                    // debug($bag_lv);exit;
...
?>
                            <tr><td colspan="4" style="background-color:#d9d9d9; color:#800000"><span><?php echo $meal_type_label; ?> ( <?= $meal_lv ?> )</span></td></tr>
                            <?php
                            foreach ($meal_details['details'] as $meal_k => $meal_v) {
                                foreach ($meal_v as $md_k => $md_v) {
                    ...
                    if (isset($booking_transaction_details_value['extra_service_details']['seat_details']) == true && valid_array($booking_transaction_details_value['extra_service_details']['seat_details']) == true) {
                        ...
                        foreach ($seat_details['seat_source_destination_label'] as $seat_lk => $seat_lv) {
                            ?>
                            <tr><td colspan="4" style="background-color:#d9d9d9; color:#800000"><span><?php echo $seat_type_label; ?> ( <?= $seat_lv ?> )</span></td></tr>
                            <?php
                            foreach ($seat_details['details'] as $seat_k => $seat_v) {
                                // debug($seat_lv);exit;
                                foreach ($seat_v as $sd_k => $sd_v) {
...
<tr>
<td align="right" colspan="4" style="line-height:26px; border-top:1px solid #800000; border-bottom:1px solid #800000;"><span style="font-size:12px;">Status: </span><strong class="<?php echo booking_status_label($booking_transaction_details[1]['status']) ?>" style=" font-size:14px;">
<?php
...
<tr>
<td style="padding:10px 0"><img style="width:60px;" src="<?= FULL_SYSTEM_IMAGE_DIR . 'airline_logo/' . $return_segment_details[0]['airline_code'] . '.gif' ?>" /></td>
...
<td style="padding:10px 0; padding-left: 10%; line-height:25px;"><span style="font-size:14px;">Agency</span><br><span><img style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'phone.png' ?>" /> <span style="font-size:16px;color:#800000;vertical-align:middle;font-weight: 600;"> &nbsp;<?php echo $data['phone'] ?></span></span></td>
<?php if ((!empty($return_gds_pnr)) || (!empty($return_airline_pnr))) { ?>
<td style="padding:10px 0;text-align: center;">
<span style="font-size:14px; border:2px solid #808080; display:block">
<?php if ($booking_transaction_details[1] ['status'] == 'BOOKING_CONFIRMED') { ?>
        <span style="color:#800000;padding:5px; display:block">AIRLINE PNR</span>
...
<tr>
<td colspan="4" style="border:1px solid #800000; padding:0;">
<table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;">
<tbody>
    <tr>
        <td colspan="5" style="background-color:#666666; color:#fff"><img style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'people_group.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:13px;">Passenger(s) Details</span></td>
    </tr>
...
<tbody>
<tr>
        <td colspan="2" style="background-color:#800000; color:#fff"><img style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'flight.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:13px"><?php echo $Return; ?> Flight Details</span></td>
        <td align="right" colspan="2" style="background-color:#800000; color:#fff"><span style="font-size:9px">*Please verify flight times with the airlines prior to departure</span></td>
    </tr>
...
?>
                <tr>
                    <td style="background-color:#d9d9d9; color:#800000"><span style="color:#006f8e">Flight <?php echo $segment_details_v['segment_indicator']; ?></span></td>
                    <td style="background-color:#d9d9d9; color:#800000"><img style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'flight_up.png' ?>">&nbsp;<span style="vertical-align:middle">Departing</span></td>
                    <td style="background-color:#d9d9d9; color:#800000"><img style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'flight_down.png' ?>">&nbsp;<span style="vertical-align:middle">Arriving</span></td>
                    <td style="background-color:#d9d9d9; color:#800000">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td><span><strong><?= @$segment_details_v['from_airport_name'] ?>(<?= @$segment_details_v['from_airport_code'] ?>)</strong><br><?php echo date("D, d M Y", strtotime($segment_details_v['departure_datetime'])) . ", " . date("H:i", strtotime($segment_details_v['departure_datetime'])); ?><br><?php echo $origin_terminal; ?></span></td>
                    <td><span><strong><?= @$segment_details_v['to_airport_name'] ?>(<?= @$segment_details_v['to_airport_code'] ?>)</strong><br><?php echo date("D, d M Y", strtotime($segment_details_v['arrival_datetime'])) . ", " . date("H:i", strtotime($segment_details_v['arrival_datetime'])); ?><br><?php echo $destination_terminal; ?></span></td>
                    <td><span style="display:block;border-left: 1px solid #999; padding-left:10%"><?php echo $non_stop; ?><br><?php echo $segment_details_v['total_duration']; ?></span></td>
                </tr>
				<tr>
                <td>&nbsp;</td>
                <td colspan="3">
...
<tr>
<td align="center">
<input style="background: #800000;padding: 6px 20px;border-radius:4px;border:none;color:#fff;margin: 0;" type="button" value="Add Markup" data-toggle="modal" data-target="#edit_amount"/>
</td>
</tr>
</tbody>
</table>
...
<input type="text" class="form-control" name="amount" id="amount" value="<?= $booking_details['agent_markup'];?>">
</div>
