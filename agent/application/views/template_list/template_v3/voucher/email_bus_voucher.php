         ...
         <td style="border-collapse: collapse; padding:50px 35px;">
            <table width="100%" style="font-family: 'Open Sans', sans-serif;border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
               <tbody>
                  ...
                  <tr>
                     <td>
                        <table width="100%" style="font-family: 'Open Sans', sans-serif;border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                           <tbody>
                              <tr>
                                 <td style="padding: 0px;" class="voucher_logo"><img src="<?=$GLOBALS['CI']->template->domain_full_images($agent_logo)?>" style="width: 100px;"></td>
                                 <td style="padding: 0px;">
                  ...
                  <tr>
                     ...
                     <tr>
                           ...
                           <td width="25%" style="padding:5px 0;text-align: center;"><span style="font-size:14px; border:2px solid #808080; display:block"><span style="color:#00a9d6;padding:5px; display:block">PNR No</span><span style="font-size:22px;line-height:35px;padding-bottom: 5px;display:block;font-weight: 600;"><?php echo $booking_details['pnr'];?></span><span style="border-top:2px solid #808080;display:block; padding:5px;">Seat: <?=@$booking_details['seat_numbers']?></span></span></td>
                              ...
                              <tr>
                                 <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=FULL_SYSTEM_IMAGE_DIR.'bus_v.png'?>"> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Reservation Ticket (<?php echo ucfirst($booking_details['departure_from']).' To '.ucfirst($booking_details['arrival_to']);?>)</span></td>
                              </tr>
                              <tr>
                  ...
                  <tr>
                     <td style="background-color:#666666;border: 1px solid #666666; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=FULL_SYSTEM_IMAGE_DIR.'people_group.png'?>"> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Traveler(s) Information</span></td>
                  </tr>
                  <tr>
                  ...
                  ?>
                   <?php foreach ($customer_details as $key => $value) {?>
                              <tr>
                                 ...
                                 ?></td>
                                 <td style="padding:5px;"><?php echo $value['status'];?></td>
                              </tr>
                              ...
                              ?>
                                  <tr>
                                      <td colspan="4" style="padding-top:10%;width:100%">
                                          <img src="<?=$this->template->domain_full_images().'offer_images/'.$adv_data[0]['image']?>" height="90" width="100%">
                                      </td>
                                  </tr>
                              <?php } ?>
                           </tbody>
