...
if (isset($return_segment_details)) {
    ...
    if (isset($return_segment_details[0]['airline_pnr']) && !empty($return_segment_details[0]['airline_pnr'])) {
        ...
        $return_gds_pnr = $booking_transaction_details[1]['gds_pnr'];
    } else {
...
if (isset($airline_contact_no['data'][0])) {
    $airline_number = '<span><img style="vertical-align:middle" src=' . FULL_SYSTEM_IMAGE_DIR . 'phone.png /><span style="font-size:12pt;color:#800000;vertical-align:middle;font-weight: 600;">' . $airline_contact_no['data'][0]['phone_number'] . '</span></span> ';
} else {
    $airline_number = '';
}
    ...
    <table cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:9pt;font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
        <tbody>
            <tr>
                ...
                <span style="font-size:12px; font-weight: bold; line-height: 7px;">Agency Info</span><br>    
                <span><?=$data['domainname']?></span><br>
                <span>Email Id: <?php echo isset($data['agency_email'])?$data['agency_email']:'NA'; ?></span><br>
				<!-- <span><?=$data['phone']?></span><br> -->
				<!-- <span><?=$data['address']?></span><br> -->
                <?php $b_date = date_create(@$booking_details['created_datetime']);
                $issue_date = date_format($b_date, 'D, jS M Y, G:i');                ?>
                <span>Booked on : <?= $issue_date; ?></span><br>
...
<?php }?>
            ...
            <tr>
            <td align="left" colspan="2" style="line-height:26px; border-top:1px solid #800000; border-bottom:1px solid #800000;"> <span>Booking ID : <?= @$booking_details['app_reference'] ?></span></td>
<td align="right" colspan="2" style="line-height:26px; border-top:1px solid #800000; border-bottom:1px solid #800000;"><span style="font-size:12px;">Status: </span><strong class="<?php echo booking_status_label($booking_transaction_details[0]['status']) ?>" style=" font-size:12px;">
<?php
...
<?php } ?>
            ...
            <tr>
                ...
                <td style="padding:10px 0; vertical-align:middle; line-height:normal;"><span style="font-size:11pt;">Agency</span><br><br><span style="font-size:12pt;color:#800000;vertical-align:middle;font-weight: 600;"><img valign="bottom" style="vertical-align:middle;width:12px;line-height:normal;" src="<?= FULL_SYSTEM_IMAGE_DIR . 'phone.png' ?>" />&nbsp; <span style="line-height:normal;"><?php echo $data['phone'] ?></span></span></td>
...
<?php if ((!empty($gds_pnr)) || (!empty($airline_pnr))) { ?>
    ...
    <?php if ($booking_transaction_details[0] ['status'] == 'BOOKING_CONFIRMED' || $booking_transaction_details[0] ['status'] == 'BOOKING_HOLD') { ?>
                                <span style="color:#800000;padding:5px; display:block;font-size: 10px;"><strong>AIRLINE PNR</strong></span><br>
                                <span style="font-size:14px;padding-bottom: 5px;display:block;font-weight: 600; border-bottom: 1px solid #800000;"><?= @$airline_pnr ?></span><br>
                    <?php } ?>
                    <?php if (($booking_transaction_details[0] ['status'] == 'BOOKING_CONFIRMED' || $booking_transaction_details[0] ['status'] == 'BOOKING_HOLD') && !empty($gds_pnr)) { ?>
                                <span style="<?php echo $border; ?> padding:5px; display:block;font-size: 10px;"><strong>GDS PNR</span>: <span style="font-size:10px;padding-bottom: 5px;display:block;font-weight: 600;"><?= @$gds_pnr ?></span></strong>
                            <?php } ?>
                        </span></td>
<?php } ?>
            </tr>
...
<table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #666666; font-size:9pt; padding:0;">
                            <tbody>
                                <tr>
                                    <td colspan="5" style="background-color:#800000; color:#fff"><img width="12" style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'people_group.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:12pt"><strong>Passenger(s) Details</strong></span></td>
                                </tr>
                                <tr>
                                    <td style="background-color:#d9d9d9;border-left:1px solid #666666; color:#800000"><span>Sr No.</span></td>
                                    <td style="background-color:#d9d9d9; color:#800000"><span>Passenger(s) Name</span></td>
                                    <td style="background-color:#d9d9d9; color:#800000"><span>Type</span></td>
                                    <td style="background-color:#d9d9d9; color:#800000"><span>E-ticket No</span></td>
									<td style="background-color:#d9d9d9;border-right:1px solid #666666; color:#800000"><span>Status</span></td>
                                </tr>
                                <?php
                                $booking_transaction_details_value = $booking_transaction_details [0];
                                // debug($booking_transaction_details_value);exit;
            ...
            <tr>
                <td colspan="4" style="padding:0;"><table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #800000;font-size:9pt; padding:0;">
                        <tbody><tr><td colspan="2" style="background-color:#800000; color:#fff"><img width="9" src="<?= FULL_SYSTEM_IMAGE_DIR . 'flight.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:12pt"><strong>Onward Flight Details</strong></span></td>     <td align="right" colspan="2" style="background-color:#800000; color:#fff;line-height:normal;vertical-align:middle;"><span style="font-size:8pt;">*Please verify flight times with the airlines prior to departure</span></td>
                            </tr>
<?php
if (isset($booking_transaction_details) && $booking_transaction_details != "") {
    ...
    foreach ($itinerary_details as $segment_details_k => $segment_details_v) {
        ...
        if (in_array($segment_details_v['segment_indicator'], $seg_in_array) && !empty($seg_in_array) && ($seg_counts == 0) && ($trip_type != 'multicity')) {
            ...
            ?>
                                        <tr>
                                            <td colspan="2" style="background-color:#800000; color:#fff"><img width="9" src="<?= FULL_SYSTEM_IMAGE_DIR . 'flight.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Return Flight Details</span></td> 
                                            <td align="right" colspan="2" style="background-color:#800000; color:#fff;line-height:normal;vertical-align:middle;"><span style="font-size:8pt;">*Please verify flight times with the airlines prior to departure</span></td>
                                        </tr>
                                    <?php
                                    }
        ...
        if (is_int($segment_details_v['cabin_baggage'])) {
            ...
            $TotalBaggageCabin = $segment_details_v['cabin_baggage'];
                                    ...
                                    if (valid_array($segment_details_v) == true) {
                                        ?>
                                        <tr>
                <td style="background-color:#d9d9d9; color:#800000"><span style="color:#800000">Flight <?php echo $fight_count; ?></span></td>
                <td style="background-color:#d9d9d9; color:#800000"><img style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'flight_up.png' ?>">&nbsp;<span style="vertical-align:middle">Departing</span></td>
                <td style="background-color:#d9d9d9; color:#800000"><img style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'flight_down.png' ?>">&nbsp;<span style="vertical-align:middle">Arriving</span></td>
                <td style="background-color:#d9d9d9; color:#800000">&nbsp;</td>
            </tr>
            <tr>
...
<?php } ?>
                <tr>
                    ...
                    <td style="border-top:1px solid #ccc"><span style="font-size:11px"> <?= number_format(@$booking_details['grand_total'], 2) ?></span></td>
                </tr>
            </tbody>
        </table>
    </td>
<?php } ?>
    ...
    if (isset($booking_transaction_details_value['extra_service_details']['baggage_details']) == true && valid_array($booking_transaction_details_value['extra_service_details']['baggage_details']) == true) {
        ...
        foreach ($baggage_details['baggage_source_destination_label'] as $bag_lk => $bag_lv) {
            ?>
                                                        <tr>
                                                            <td colspan="4" style="background-color:#d9d9d9; color:#800000"><span><?php echo 'Extra Baggage Information'; ?> ( <?= $bag_lv ?> )</span></td>
                                                        </tr>
            <?php
            foreach ($baggage_details['details'] as $bag_k => $bag_v) {
                foreach ($bag_v as $bd_k => $bd_v) {
    ...
    if (isset($booking_transaction_details_value['extra_service_details']['meal_details']) == true && valid_array($booking_transaction_details_value['extra_service_details']['meal_details']) == true) {
        ...
        foreach ($meal_details['meal_source_destination_label'] as $meal_lk => $meal_lv) {
            ?>
                                                        <tr>
                                                            <td colspan="4" style="background-color:#d9d9d9; color:#800000"><span><?php echo $meal_type_label; ?> ( <?= $meal_lv ?> )</span></td>
                                                        </tr>
                                                        <?php
                                                        foreach ($meal_details['details'] as $meal_k => $meal_v) {
                                                            foreach ($meal_v as $md_k => $md_v) {
                                                ...
                                                if (isset($booking_transaction_details_value['extra_service_details']['seat_details']) == true && valid_array($booking_transaction_details_value['extra_service_details']['seat_details']) == true) {
                                                    ...
                                                    foreach ($seat_details['seat_source_destination_label'] as $seat_lk => $seat_lv) {
                                                        ?>
                                                        <tr>
                                                            <td colspan="4" style="background-color:#d9d9d9; color:#800000"><span><?php echo $seat_type_label; ?> ( <?= $seat_lv ?> )</span></td>
                                                        </tr>
            <?php
            foreach ($seat_details['details'] as $seat_k => $seat_v) {
                // debug($seat_lv);exit;
...
// debug($airline_contact_no);exit;
    if (isset($airline_contact_no['data'][0])) {
        $airline_number = '<span><img style="vertical-align:middle" src=' . FULL_SYSTEM_IMAGE_DIR . 'phone.png /><span style="font-size:16px;color:#800000;vertical-align:middle;font-weight: 600;"> &nbsp;' . $airline_contact_no['data'][0]['phone_number'] . '</span></span> ';
    } else {
        $airline_number = '';
    }
    ...
    <div style="background:#ccc; width:100%; position:relative">
        <table class="pag_brk" cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:9pt; font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
            <tbody>
                ...
                <tr>
                    <td align="right" colspan="4" style="line-height:25px;font-size:12px; border-top:2px solid #800000; border-bottom:1px solid #800000;"><span style="font-size:9pt;">Status: </span><strong class="<?php echo booking_status_label($booking_transaction_details[1]['status']) ?>" style=" font-size:12px;">
                            <?php
                ...
                <tr>
                    ...
                    <td style="padding:10px 0; vertical-align:middle; padding-left: 10%; line-height:normal;"><span style="font-size:11pt;">Agency</span><br><br><span style="font-size:12pt;color:#800000;vertical-align:middle;font-weight: 600;"><img valign="bottom" style="vertical-align:middle;width:12pt;line-height:normal;" src="<?= FULL_SYSTEM_IMAGE_DIR . 'phone.png' ?>" />&nbsp; <span style="line-height:normal;"><?php echo $data['phone'] ?></span></span></td>
<?php if ((!empty($return_gds_pnr)) || (!empty($return_airline_pnr))) { ?>
                    <td style="padding:5px 0;text-align: center;border:2px solid #808080;">
                        <span style="font-size:12px; display:block;border:2px solid #808080;">
    <?php if ($booking_transaction_details[1] ['status'] == 'BOOKING_CONFIRMED' || $booking_transaction_details[1] ['status'] == 'BOOKING_HOLD') { ?>
                                <span style="color:#800000;padding:5px; display:block;font-size: 10px;">AIRLINE PNR</span><br>
                    ...
                    <?php if (($booking_transaction_details[0] ['status'] == 'BOOKING_CONFIRMED' || $booking_transaction_details[1] ['status'] == 'BOOKING_HOLD') && !empty($gds_pnr)) { ?>
                                <span style="<?php echo $border; ?> color:#800000;padding:5px; display:block;font-size: 10px;">GDS PNR</span><br><span style="font-size:14px;padding-bottom: 5px;display:block;font-weight: 600;"><?= @$return_gds_pnr ?></span>
                            <?php } ?>
                        </span></td>
<?php } ?>
                </tr>
                ...
                <tr>
                    <td colspan="4" style="padding:0;">
                        <table border="0" cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #800000;font-size:9pt; padding:0;">
                            <tbody>
                                <tr>
                                    <td colspan="2" style="background-color:#800000; color:#fff"><img width="9" src="<?= FULL_SYSTEM_IMAGE_DIR . 'flight.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt"><?php echo $Return; ?>Flight Details</span></td>
                                    <td align="right" colspan="2" style="background-color:#800000; color:#fff;line-height:normal;vertical-align:middle;"><span style="font-size:8pt;">*Please verify flight times with the airlines prior to departure</span></td>
                                </tr>
                                <?php
                                if (isset($booking_transaction_details) && $booking_transaction_details != "") {
        ...
        if (is_int($segment_details_v['cabin_baggage'])) {
            ...
            $TotalBaggageCabin = $segment_details_v['cabin_baggage'];
                                        ...
                                        if (valid_array($segment_details_v) == true) {
                                            ?>
                                            <tr>
                                                <td style="background-color:#d9d9d9;border-left:1px solid #800000; color:#800000"><span style="color:#006f8e">Flight <?php echo $segment_details_v['segment_indicator']; ?></span></td>
                                                <td style="background-color:#d9d9d9;color:#800000"><img width="15" style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'flight_up.png' ?>">&nbsp;<span style="vertical-align:middle">Departing</span></td>
                                                <td style="background-color:#d9d9d9;color:#800000"><img width="15" style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'flight_down.png' ?>">&nbsp;<span style="vertical-align:middle">Arriving</span></td>
                                                <td style="background-color:#d9d9d9;border-right:1px solid #800000; color:#800000">&nbsp;</td>
                                            </tr>
                                            <tr>
                ...
                <tr>
                    <td colspan="4" style="padding:0;">
                        <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #666666; font-size:9pt; padding:0;">
                            <tbody>
                                <tr>
                                    <td colspan="5" style="background-color:#800000; color:#fff"><img width="12" style="vertical-align:middle" src="<?= FULL_SYSTEM_IMAGE_DIR . 'people_group.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt"><strong>Passenger(s) Details</strong></span></td>
                                </tr>
                                <tr>
                                    <td style="background-color:#d9d9d9;border-left:1px solid #666666; color:#800000"><span>Sr No.</span></td>
                                    <td style="background-color:#d9d9d9; color:#800000"><span>Passenger(s) Name</span></td>
