                ...
                <div class="col-md-8 col-xs-12 nopad fulatnine">
                    <div class="detailtab">
                        <ul class="nav nav-tabs trul">
                          <li class="active trooms"><a href="#ovrvw" data-toggle="tab">OverView</a></li>
                          <li class=""><a href="#itnery" data-toggle="tab">Detailed Itinerary</a></li>
                       ...
                       <!-- Over View-->
                        <div class="tab-pane active" id="ovrvw">
