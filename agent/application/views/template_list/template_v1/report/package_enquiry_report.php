						...
						<?php
							...
							if (isset($table_data) == true and valid_array($table_data['booking_details']) == true) {
								...
								foreach($booking_details as $parent_k => $parent_v) {
									...
									$action.='<br/> ';
									$action .= '<a href="'.base_url().'index.php/voucher/b2b_voucher/'.$attributes['tour_id'].'" class="btn form-control">Selected Itinerary</a>';
									$action.='<br/> ';
								...
								?>
									<tr>
										...
										<td><?php echo $agent_net_fare;?></td>
										
										<td><?php echo $total_agent_markup;?></td>
										<td><?php echo $payment_mode; ?></td>
										<td><?php echo $gst_val;?></td>
