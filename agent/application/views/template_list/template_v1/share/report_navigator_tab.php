...
<div class="extra_content">
    ...
    <?php 
    	if(!empty($_GET)){?>
    	<input type="hidden" value="1" id="filter_f" name="filter_f">
    <?php } ?>
    <!-- Search Ends Ends -->
    ...
    <div class="list_of_sections">
		<a id="current_date" class="<?=(($today_search == @$_GET['today_booking_data']) ? 'active' : '')?>" href="<?=base_url().'report/'.$default_view.'?today_booking_data='.$today_search?>">Today Search</a>
