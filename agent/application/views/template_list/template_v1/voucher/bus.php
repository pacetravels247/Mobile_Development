...
$message = '';
$message.='<div style="width:1024px; border:#080808 1px solid; margin:auto; font-family:Arial, Helvetica, sans-serif; padding:2px;" id="voucher">
...
<tr>
<td align="right"><span style="font-size:16px; padding:5px;"> <strong>'.$itinerary_details[0]['operator'].'</strong> </span></td>
</tr>
<tr>
<td align="right"><span style="font-size:14px; padding:5px;">'.$itinerary_details[0]['bus_type'].'</span></td>
</tr>
</table></td>    
</tr>
</table>
...
<tr>
<td width="23%"> '.date("l, M jS Y",strtotime($itinerary_details[0]['journey_datetime'])).'</td>
<td width="36%" align="center" style="font-size:25px; font-weight:bold;">'.ucfirst($itinerary_details[0]['departure_from']).'-to-'.ucfirst($itinerary_details[0]['arrival_to']).'</td>
...
<tr>
<td><strong>'.$itinerary_details[0]['operator'].'</strong></td>
<td><strong>'.$itinerary_details[0]['bus_type'].'</strong></td>
';

$message.='</td>
<td><strong>'.$itinerary_details[0]['departure_datetime'].'</strong></td>
<td><strong>Location: </strong>'.$itinerary_details[0]['boarding_from'].'</td>
</tr>
</table>
<div style="border-bottom:#666 1px dashed"></div>  
...
<tr>
<td><strong>'.app_friendly_date($booking_details['created_datetime']).'</strong></td>
<td><strong>'.$itinerary_details[0]['departure_from'].'</strong></td>
<td><strong>'.$itinerary_details[0]['arrival_to'].'</strong></td>
...
<tr>
<td colspan="5">
<div style="width:100%; height:20px; text-align:right; border-top:#666 solid 1px; padding-top:10px; font-size:15px;"><strong>Total Fare: '.$booking_details['currency'].' '.$booking_details['grand_total'].'/-</strong></div>
</td>
</tr>
</table>  
