...
<script>
$(document).ready(function() {
//#date of transaction field has to be defaulted to today	
	...
	var date_of_transaction = $("#date_of_transaction").val();
	if(date_of_transaction.trim() == "")
	{
		$("#date_of_transaction").val(getTodaydate());
	}
//End of getting today date
//Mandate Deposite slip
	$(".dip_slip_req").attr("required", "required");
	$(".dip_slip_req").parent(".col-sm-6").siblings(".control-label").text("Bank Deposit slip*");
//Mandate Deposite slip END
