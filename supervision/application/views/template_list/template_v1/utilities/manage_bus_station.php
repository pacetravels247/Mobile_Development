				...
				<table id="example" class="display nowrap" style="width:100%">
			        <thead>
			            <tr>
			                ...
			                <th>krl_city_id</th>
			                <th>sr_konduskar_id</th>
			                <th>srs_city_id</th> 	
			                <th>goutour_city_id</th> 	
			                <th>kadri_city_id</th> 	
			                <th>konduskar_city_id</th> 	
			                <th>Barde_city_id</th> 	
			                <th>Infinity_city_id</th> 	
			                <th>Action</th>
			            </tr>
			        </thead>
    			</table>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	<form class="form-horizontal" action="<?php echo base_url()?>utilities/add_new_station" method="POST">
			  ...
			  <div class="form-group">
			    <label class="control-label col-sm-3" for="a_name">sr_konduskar_id:</label>
			    <div class="col-sm-5"> 
			      <input type="text" class="form-control" name="sr_konduskar_id" id="sr_konduskar_id" placeholder="sr_konduskar_id" required="required">
			    </div>
			  </div>
			  <div class="form-group">
			    <label class="control-label col-sm-3" for="a_name">srs_city_id:</label>
			    <div class="col-sm-5"> 
			      <input type="text" class="form-control" name="srs_city_id" id="srs_city_id" placeholder="srs_city_id" required="required">
			    </div>
			  </div>
			  <div class="form-group">
			    <label class="control-label col-sm-3" for="bitla_id">gotour_city_id:</label>
			    <div class="col-sm-5"> 
			      <input type="text" class="form-control" name="gotour_city_id" id="gotour_city_id" placeholder="gotour_city_id" required="required">
			    </div>
			  </div><div class="form-group">
			    <label class="control-label col-sm-3" for="bitla_id">kadri_city_id:</label>
			    <div class="col-sm-5"> 
			      <input type="text" class="form-control" name="kadri_city_id" id="kadri_city_id" placeholder="kadri_city_id" required="required">
			    </div>
			  </div><div class="form-group">
			    <label class="control-label col-sm-3" for="bitla_id">konduskar_city_id:</label>
			    <div class="col-sm-5"> 
			      <input type="text" class="form-control" name="konduskar_city_id" id="konduskar_city_id" placeholder="konduskar_city_id" required="required">
			    </div>
			  </div><div class="form-group">
			    <label class="control-label col-sm-3" for="bitla_id">barde_city_id:</label>
			    <div class="col-sm-5"> 
			      <input type="text" class="form-control" name="barde_city_id" id="barde_city_id" placeholder="barde_city_id" required="required">
			    </div>
			  </div>
			  <div class="form-group">
			    <label class="control-label col-sm-3" for="bitla_id">infinity_city_id:</label>
			    <div class="col-sm-5"> 
			      <input type="text" class="form-control" name="infinity_city_id" id="infinity_city_id" placeholder="infinity_city_id" required="required">
			    </div>
			</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	<form class="form-horizontal" action="<?php echo base_url()?>utilities/update_new_stations" method="POST">
			  ...
			  <div class="form-group">
			    <label class="control-label col-sm-3" for="bitla_id">sr_konduskar_id:</label>
			    <div class="col-sm-5"> 
			      <input type="text" class="form-control" name="sr_konduskar_id" id="sr_konduskar_id_e" placeholder="sr_konduskar_id" required="required">
			    </div>
			  </div>
			  <div class="form-group">
			    <label class="control-label col-sm-3" for="bitla_id">srs_city_id:</label>
			    <div class="col-sm-5"> 
			      <input type="text" class="form-control" name="srs_city_id" id="srs_city_id_e" placeholder="srs_city_id" required="required">
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    <label class="control-label col-sm-3" for="bitla_id">gotour_city_id:</label>
			    <div class="col-sm-5"> 
			      <input type="text" class="form-control" name="gotour_city_id" id="gotour_city_id_e" placeholder="gotour_city_id" required="required">
			    </div>
			  </div><div class="form-group">
			    <label class="control-label col-sm-3" for="bitla_id">kadri_city_id:</label>
			    <div class="col-sm-5"> 
			      <input type="text" class="form-control" name="kadri_city_id" id="kadri_city_id_e" placeholder="kadri_city_id" required="required">
			    </div>
			  </div><div class="form-group">
			    <label class="control-label col-sm-3" for="bitla_id">konduskar_city_id:</label>
			    <div class="col-sm-5"> 
			      <input type="text" class="form-control" name="konduskar_city_id" id="konduskar_city_id_e" placeholder="konduskar_city_id" required="required">
			    </div>
			  </div><div class="form-group">
			    <label class="control-label col-sm-3" for="bitla_id">barde_city_id:</label>
			    <div class="col-sm-5"> 
			      <input type="text" class="form-control" name="barde_city_id" id="barde_city_id_e" placeholder="barde_city_id" required="required">
			    </div>
			  </div>
			  <div class="form-group">
			    <label class="control-label col-sm-3" for="bitla_id">infinity_city_id:</label>
			    <div class="col-sm-5"> 
			      <input type="text" class="form-control" name="infinity_city_id" id="infinity_city_id_e" placeholder="infinity_city_id" required="required">
			    </div>
			</div>
...
$(document).on('click','.edit_details',function(){
	...
	$('#sr_konduskar_id_e').val($(this).data('sr_konduskar_id'));
	$('#srs_city_id_e').val($(this).data('srs_city_id'));
	$('#gotour_city_id_e').val($(this).data('gotour_city_id'));
	$('#kadri_city_id_e').val($(this).data('kadri_city_id'));
	$('#konduskar_city_id_e').val($(this).data('konduskar_city_id'));
	$('#barde_city_id_e').val($(this).data('barde_city_id'));
	$('#infinity_city_id_e').val($(this).data('infinity_city_id'));
