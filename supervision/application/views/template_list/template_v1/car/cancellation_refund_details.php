...
<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
	...
	<li role="presentation" class="active"><a
		...
		data-toggle="tab"> <i class="fa fa-home"></i> Car Cancellation Details
	</a></li>
...
<form class="form-horizontal" role="form" method="POST" action="<?=base_url()?>index.php/car/update_refund_details" autocomplete="off" name="refund_details">
	<div class="panel-body">
		<div class="col-md-12">
