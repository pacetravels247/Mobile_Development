...
<div class="search-result">
	...
	<div class="bakrd_color">
    	...
    	<div class="cancellation_page">
        	<div class="head_can">
            	<h3 class="canc_hed">Offline Cancellation</h3>
            ...
            <div class="col-xs-12">
             <form method="POST" action="<?=base_url().'index.php/hotel/offline_cancel_booking'?>">
             	<input type="hidden" name="booking_source" value="<?php echo $booking_details['booking_source'];?>">
             	<input type="hidden" name="app_reference" value="<?php echo $booking_details['app_reference']; ?>">
             	...
             	<div class="form-group">
				    ...
				    <div class="col-sm-4">
				      <input type="number" class="form-control" id="api_r_amount" name="api_r_amount" placeholder="api refund amount">
				    </div>
			  	</div>
			  	<div class="form-group">
			    	<label class="control-label col-sm-2" for="pwd">Refund Amount:</label>
		   		 	<div class="col-sm-4"> 
			      		<input type="number" class="form-control" id="refund_amount" name="refund_amount" placeholder="Refund amount">
			    	</div>
			  	</div>
			  	<div class="form-group">
			    	<label class="control-label col-sm-2" for="pwd">Cancellation Charge:</label>
		   		 	<div class="col-sm-4"> 
			      		<input type="number" class="form-control" id="cancellation_charge" name="cancellation_charge" placeholder="Refund amount">
			    	</div>
			  	</div>
			  	<div class="form-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="<?=base_url().'index.php/hotel/offline_cancel_booking/'.$app_reference.'/'.$booking_source?>" class="btn btn-danger">Yes</a>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
