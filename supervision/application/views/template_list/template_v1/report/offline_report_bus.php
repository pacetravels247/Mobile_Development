						...
						<?php
							if (isset($table_data) == true and valid_array($table_data['booking_details']) == true) {
								...
								foreach($booking_details as $parent_k => $parent_v) {
									...
									$base_fare = $total_api_base_fare;
									$comm_fare = $base_fare+$total_api_tax;
								...
								?>
									<tr>
										...
										<td><?php echo $comm_fare?></td>
										<th><?php echo $admin_commission; ?></th>
										<th><?php echo $admin_tds; ?></th>
										<th><?php echo $pace_commission; ?></th>
										<th><?php echo $pace_tds; ?></th>
