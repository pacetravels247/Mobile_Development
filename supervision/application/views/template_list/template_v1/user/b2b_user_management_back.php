...
<?php } ?>
	...
	<div class="col-sm-12 well well-sm">
		...
		<button class="btn btn-warning" type="submit" name="excel_export" value="1">Export</button>
...
{
	return '<a role="button" href="'.base_url().'index.php/user/b2b_user?'.$_SERVER['QUERY_STRING'].'&	eid='.$id.'" class="btn btn-sm btn-primary" title="Edit Details">
