...
function get_table($table_data = '',$get_privilage='') {
   ...
   <th>Select <button class="btn btn-xs btn-primary" id="btn_select_all" data-check="" type="button">All</button></th>
	...
	$header_pivilege = array("p1","p2","p3","p4","p5","p6","p7","p8","p9","p10","p11","p12","p13","p14","p15","p16","p74","p75","p36","p35","p44","p45","p46","p47","p48","p49","p50","p51","p52","p53","p54","p55","p64","p119","p118","p117","p116","p115","p114","p130","p131","p140","p142","p141","p151","p152","p154","p169","p176","p177","p178","p185","p186","p187","p188","p193","p194");
