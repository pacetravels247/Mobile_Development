...
<div class="bodyContent col-md-12">
    <div class="panel panel-primary clearfix">
        <!-- PANEL WRAP START -->
        <div class="panel-heading"><h4>Offline Bus Ticket Booking</h4>
            <!-- PANEL HEAD START -->
        </div>
        <!-- PANEL HEAD START -->
        <div class="panel-body">
            <form method="POST" id="offline_booking" autocomplete="off"
                  action="<?php echo base_url() . 'index.php/general/offline_bus_book'?>">
                <div class="clearfix form-group">
                    ...
                    <div class="col-md-4">
						...
						<select class="form-control select2" name="agent_id" id="agent_id" onchange="check_agent_balance(this.value)" required>
				...
				<div class="col-xs-4">
					...
					<select class="form-control" name="travel_id">
						...
						<?= generate_options($bitla_direct_api_list, (array) @$travel_id) ?>
					</select>
				</div>
				</div>		
                ...
                <div class="onward_flight_details">
                    ...
                    <div class="clearfix form-group">
                        ...
                        <div class="col-md-2">
                            <label>Board. Date/Drop. Date</label>
                        </div>
                        <div class="col-md-2">
                            <label>Board. Time/Drop. Time</label> 
                        </div>
                        <div class="col-md-2">
                            <label>Book Id</label> 
                        </div>
                    ...
                    <div class="onward_flight_row" data-count="<?= @$sect_num_onward; ?>">
                        ...
                        for ($i = 0; $i < @$sect_num_onward; $i++):
                            ...
                            <div class="clearfix form-group">
                                <div class="col-md-2">
                                    <input type="text" class="form-control" name="career_onward[]" maxlength="45" value="<?= @$career_onward[$i]; ?>" placeholder="Operator Name" required>

                                    <input type="text" class="form-control" name="carrier_type[]" maxlength="45" value="<?= @$carrier_type[$i]; ?>" placeholder="Operator Type" required>

                                </div>
                                <div class="col-md-2">
                                    <input type="text" class="form-control" name="bus_from[]" value="<?= @$bus_from[$i]; ?>" placeholder="Bus From.">
                                    <input type="text" class="form-control" name="bus_to[]" value="<?= @$bus_to[$i]; ?>" placeholder="Bus TO.">                                
                                </div>
                                <div class="col-md-2">
                                    <input type="text" class="form-control" name="dep_loc_onward[]" value="<?= @$dep_loc_onward[$i]; ?>" placeholder="Board. Code" maxlength="45" required>
                                    <input type="text" class="form-control" name="arr_loc_onward[]" value="<?= @$arr_loc_onward[$i]; ?>" placeholder="Drop. Code" maxlength="45"required>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="airline_pnr_onward[]" value="<?= @$airline_pnr_onward[$i]; ?>" placeholder="Book Id">
                                </div>              
                            </div>
                        <?php endfor; ?>
                    </div>
                            ...
                            <div class="clearfix form-group">
                                <div class="col-md-1">
                                    ...
                                    <select class="form-control title_nme" name="pax_title[]">
                                        <?= generate_options(get_enum_list('sex'),(array) @$pax_title[$i]) ?>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-1">
                                    <input type="text" class="form-control" name="age[]" value="<?= @$age[$i]; ?>" placeholder="Age">
                                </div>
                                <div class="col-md-2">
                                    <input type="text" class="form-control" id="seat_no_<?= $i; ?>" name="seat_no[]" value="<?= @$seat_no[$i]; ?>" placeholder="Seat No.">
                                </div>
                                <div class="col-md-2">
                                    <input type="text" class="form-control" name="pax_ticket_num_onward[]" value="<?= @$pax_ticket_num_onward[$i]; ?>" placeholder="PNR" <?= @$is_lcc == 'gds' ? 'required' : '' ?>>
                ...
                <div class="clearfix form-group">
					...
					<div class="col-md-4">
                        <label>GST</label> 
                        <input type="text" class="form-control" name="gst" value="<?= intval(@$gst); ?>" placeholder="GST">
                    </div> 	
                </div>
                <div class="clearfix form-group">
                    <div class="col-md-4">
                        <label>Total Fare</label>
                        <input type="text" class="form-control" id="agent_buying_price" name="agent_buying_price" value="<?= intval(@$agent_buying_price); ?>" readonly>
                    </div>
                   <!--  <div class="col-md-4">
                        <label>Total Fare</label>
				...
				<a href="#cancel_policy_md" class="add_cp_row btn btn-primary btn-xs" style="margin-right: 10px;">+Add Row</a>
				<a href="#cancel_policy_md" class="rm_cp_row btn btn-primary btn-xs">-Remove Row</a>
				<div id="cancel_policy_md">
                <div class="clearfix form-group cancel_policy_row">
                    <div class="col-md-4">
                        <label>From Hours</label> 
                        <input type="text" class="form-control" name="c_from_hours[]" value="0" placeholder="From Hours">
                    </div>
                    <div class="col-md-4">
                        <label>To Hours</label> 
                        <input type="text" class="form-control" name="c_to_hours[]" value="0" placeholder="To Hours">
                    </div>
                    <div class="col-md-4">
                        <label>Cancellation Percentage</label> 
                        <input type="text" class="form-control" name="c_perc[]" value="0" placeholder="Cancellation Percentage">
                    </div>                
                </div>
				</div>
                <div class="clearfix form-group">
...
<script>
    $(document).ready(function () {
        $('.select2').select2(); 
		$('.add_cp_row').click(function(){
			var row = '<div class="clearfix form-group cancel_policy_row">';
                row += '<div class="col-md-4">';
                row += '<label>From Hours</label>';
                row += '<input type="text" class="form-control" name="c_from_hours[]" value="0" placeholder="From Hours">';
                row += '</div>';
                row += '<div class="col-md-4">';
                row += '<label>To Hours</label>';
                row += '<input type="text" class="form-control" name="c_to_hours[]" value="0" placeholder="To Hours">';
                row += '</div>';
                row += '<div class="col-md-4">';
                row += '<label>Cancellation Percentage</label>';
                row += '<input type="text" class="form-control" name="c_perc[]" value="0" placeholder="Cancellation Percentage">';
                row += '</div>';              
                row += '</div>';
			$('#cancel_policy_md').append(row);
		});
		$('.rm_cp_row').click(function(){
			$('#cancel_policy_md .cancel_policy_row:last-child').remove();
		});
		$('#offline_booking').submit(function(e){
			if(parseFloat($("#agent_buying_price").val())<=0)
			{
				alert("Total amount must be greater than zero. Please click on calculate button and try.");
				e.preventDefault();
				return false;
			}
			else{
				$('#offline_booking').submit();
			}
		});
        ...
        $('.tot-calc').on('click', function () {
            $.post(app_base_url + "index.php/general/offline_fare_calculate/", $('#offline_booking').serialize(), function (data, status, xhr) {
                ...
                $('input[name="agt_comm"]').val(parseFloat(data.commission));
				$('input[name="gst"]').val(parseFloat(data.service_tax));
        ...
        function get_pax_row(type, count) {
            ...
            //alert(_c);
            if (_c < count) {
                $.get(app_base_url + "index.php/general/get_offline_bus_pax_row/" + type, {'trip_type': $('[name="trip_type"]:checked').val(), 'c_type': $('[name="is_lcc"]').val()}, function (data, status, xhr) {
                    if ($.trim(data) != '') {
                        while (++_c <= count) {
                            $_row.append(data);
