...
<div id="Package" class="bodyContent col-md-12">
	<div class="panel panel-default">
			...
			<div class="panel-title">
				<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
					...
					<li role="presentation" class="active" id="add_package_li"><a
						...
						data-toggle="tab">Package Theme </a></li>
		...
		<div class="panel-body">
			<!-- PANEL BODY START -->
			<form
				action="<?php echo base_url(); ?>index.php/tours/tour_subtheme_save"
					...
					<div role="tabpanel" class="tab-pane active" id="add_package">
						   <div class="col-md-12">
							...
							<div class='form-group'>
								<label class='control-label col-sm-3' for='validation_current'>Package Theme
								</label>
	...
	<!-- PANEL WRAP END -->
        ...
        foreach ($tour_subtheme as $key => $data) {
        if($data['status']==1)
        {
        ...
        echo '<tr>
              <td>'.$sn.'</td>
              <td>'.$data['tour_subtheme'].'</td>';
        //echo '<td>'.$galleryImages.'</td>';
        echo '<td>'.$status.'</td>';
        if($data['status']==1)
        {
        echo '<td>
              <a class="" data-placement="top" href="'.base_url().'index.php/tours/activation_tour_subtheme/'.$data['id'].'/0"
        ...
        {
        echo '<td>
              <a class="" data-placement="top" href="'.base_url().'index.php/tours/activation_tour_subtheme/'.$data['id'].'/1"
              data-original-title="Activate Tour Destination"> <i class="glyphicon glyphicon-th-large"></i></i> Activate
              </a>
              </td>';
        }      
        echo '<td class="center">
              <a class="" data-placement="top" href="'.base_url().'index.php/tours/edit_tour_subtheme/'.$data['id'].'"
		...
		$(document).ready(function()
		{
          ...
          $(".callDelete").click(function() { 
            $id = $(this).attr('id'); //alert($id);
		        ...
		        if($response==true){ window.location='<?=base_url()?>index.php/tours/delete_tour_subtheme/'+$id; } else{}
           });
		});
        </script>
       <?php
