				...
				<div class="tab-content">
					...
					<div role="tabpanel" class="tab-pane active" id="add_package">
						   <div class="col-md-12">
							...
							<div class='form-group'>
								<label class='control-label col-sm-3' for='validation_current'>Terms and Conditions
								</label>
								<div class='col-sm-8 controls'>
									<textarea class="form-control" rows="5" id="terms_n_conditions" name="terms_n_conditions"></textarea>
							...
							<div class='form-group'>
								...
								<div class='col-sm-8 controls'>
									<textarea class="form-control" rows="5" id="cancellation_policy" name="cancellation_policy"></textarea>
