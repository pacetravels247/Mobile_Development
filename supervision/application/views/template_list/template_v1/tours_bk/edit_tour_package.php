 ...
 -->
 						...
 						<!-- 	<div class='form-group'>
							...
							<div class="form-group multi_date <?=$group_hide_class?>">
								...
								<div class='col-sm-6 controls multi_date_sections'>		<input id="multi_date" placeholder="Enter Date" name="multi_date" class="form-control add_pckg_elements" value="<?=$tour_data['multi_date']?>">
								</div>
							</div>
							<div class='form-group'>
