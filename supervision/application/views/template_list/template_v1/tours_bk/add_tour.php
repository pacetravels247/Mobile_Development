					...
					<div role="tabpanel" class="tab-pane active" id="add_package">
						...
						<!--	<div class='form-group'>
							...
							<div class=' valid hidden multi_date_block'>
								<div class="form-group multi_frm_to_date">
									...
									<div class='col-sm-3 controls'>
										<input type="date" placeholder="Enter Date" name="valid_frm[]" class='form-control add_pckg_elements valid_frm' >
									</div>
									<label class='control-label col-sm-1'>Valid To <span style = "color:red">*</span></label>
									<div class='col-sm-3 controls'>
										<input type="date" placeholder="Enter Date" name="valid_to[]" class='form-control add_pckg_elements valid_to' >
									</div>
							...
							<div class="form-group multi_date hidden">
								...
								<div class='col-sm-6 controls multi_date_sections'>		<input id="multi_date" placeholder="Enter Date" name="multi_date" class="form-control add_pckg_elements" value="">
								</div>
							</div>
