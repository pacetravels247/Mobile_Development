...
<div id="Package" class="bodyContent col-md-12">
    <div class="panel panel-default">
            ...
            <div class="panel-title">
                <ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
                    ...
                    <li role="presentation" class="active" id="add_package_li"><a
                            ...
                            data-toggle="tab">Edit Exclusion </a></li>			
                </ul>
            </div>
        </div>
        <!-- PANEL HEAD START -->
        <div class="panel-body">
            <!-- PANEL BODY START -->
            <form
                action="<?php echo base_url(); ?>index.php/tours/edit_exclusion_save"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class='form-group'>
								...
								<div class='col-sm-8 '>        
								 <select class='form-control js-example-basic-single'  name='tour_country' id="tour_country" data-rule-required='true' required>
								  ...
								  {
									  if($v['id']==$exclusion_details['country']){
										  $selected="selected";
									  }else{
										  $selected="";
									  }
							...
							<div class='form-group'>
								...
								<div class='col-sm-8 controls'>
									<textarea	name="description" required id="editor"><?=$exclusion_details['desctiption']?></textarea>									
								</div>
							</div>		
                            <div class='' style='margin-bottom: 0'>
                                <div class='row'>
                                    <div class='col-sm-9 col-sm-offset-3'>	
                                       <input type="hidden" name="id" value="<?=$exclusion_details['id']?>">				
                                        <button class='btn btn-primary form_subm' type='submit'>Update</button>
                                        <a href="<?php echo base_url(); ?>index.php/tours/exclusions_list" class='btn btn-primary' style="color:white;">Cancel</a>
