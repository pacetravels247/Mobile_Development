   ...
   <table class="table table-bordered">
    <thead>
	 ...
	 // debug($tours_enquiry);
      ...
      if($data['status']==1)
       {
        echo ' <a href="#" data-toggle="modal" data-target="#remarks_'.$data["id"].'"><i class="fa fa-file-o"></i> Update Agent Remarks</a><br>';
      ...
      else
      {
        if(!empty($data['tour_id'])){
           $action .= '<br>
        <a href="#" class="approve_modal_btn" data-toggle="modal" data-target="#approve-modal" data-enquiry="'.$data['enquiry_reference_no'].'" data-tour_id="'.$data['tour_id'].'" data-price="'.$data['price'].'" "><i class="fa fa-file-o"></i> Approve/Quote</a><br>';
       }
      ...
      echo '<a href="#" data-toggle="modal" data-target="#remarks_'.$data["id"].'"><i class="fa fa-file-o"></i> Reply to customer
      </a><br>';
