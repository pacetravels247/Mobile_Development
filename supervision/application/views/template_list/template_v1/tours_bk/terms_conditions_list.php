...
<div id="Package" class="bodyContent col-md-12">
	<div class="panel panel-default">
			...
			<div class="panel-title">
				<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
					...
					<li role="presentation" class="active" id="add_package_li"><a
						...
						data-toggle="tab">Terms and Conditions List </a></li>
		...
		<div class="panel-body">
			<!-- PANEL BODY START -->
			<form
				action="<?php echo base_url(); ?>index.php/tours/terms_conditions_data_save"
	...
	<!-- PANEL WRAP END -->
		...
		$pos=substr($data['desctiption'],0,30).'...';
        echo '<tr>
              <td>'.$sn.'</td>
              <td>'.$pos.'</td>
			  <td>'.$data['name'].'</td>';
        ...
        {
        echo '<td>
              <a class="" data-placement="top" href="'.base_url().'index.php/tours/activation_terms_conditions/'.$data['id'].'/0"
        ...
        {
        echo '<td>
              <a class="" data-placement="top" href="'.base_url().'index.php/tours/activation_terms_conditions/'.$data['id'].'/1"
              data-original-title="Activate Tour Destination"> <i class="glyphicon glyphicon-th-large"></i></i> Activate
              </a>
              </td>';
        }      
        echo '<td class="center">
              <a class="" data-placement="top" href="'.base_url().'index.php/tours/edit_terms_conditions_data/'.$data['id'].'"
		...
		$(document).ready(function()
		{
          ...
          $(".callDelete").click(function() { 
            $id = $(this).attr('id'); //alert($id);
		        ...
		        if($response==true){ window.location='<?=base_url()?>index.php/tours/delete_terms_conditions/'+$id; } else{}
           });
			...
			$(document).on('click','.form_subm',function(e){
				...
				if($('input select').hasClass('invalid-ip')){
					alert("Please enter all the fields");
				}
			});
		});
