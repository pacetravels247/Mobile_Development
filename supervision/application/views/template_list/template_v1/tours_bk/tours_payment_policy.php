...
<div id="Package" class="bodyContent col-md-12">
	<div class="panel panel-default">
			...
			<div class="panel-title">
				<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
					...
					<li role="presentation" class="active" id="add_package_li"><a
						...
						data-toggle="tab">Payment Policy List </a></li>
		...
		<div class="panel-body">
			<!-- PANEL BODY START -->
			<form
				action="<?php echo base_url(); ?>index.php/tours/payment_policy_data_save"
				...
				<div class="tab-content">
					...
					<div role="tabpanel" class="tab-pane active" id="add_package">
						   <div class="col-md-12">
							...
							<div class='form-group'>
								<label class='control-label col-sm-3' for='validation_current'>B2B Description
								</label>
								<div class='col-sm-8 controls'>
									<textarea	name="b2b_description" required id="b2b_description"></textarea>									
								</div>
							</div>
							<div class='form-group'>
								<label class='control-label col-sm-3' for='validation_current'>B2C Description
								</label>
								<div class='col-sm-8 controls'>
									<textarea	name="b2c_description" required id="b2c_description"></textarea>									
								</div>
							</div>		
	...
	<!-- PANEL WRAP END -->
        ...
        foreach ($payment_policy_list as $key => $data) {
        if($data['status']==1)
        {
		...
		$b2b_pos=substr($data['b2b_description'],0,40).'...';
		$b2c_pos=substr($data['b2c_description'],0,40).'...';
        echo '<tr>
              <td>'.$sn.'</td>
              <td>'.$b2b_pos.'</td>
			  <td>'.$b2c_pos.'</td>
        ...
        {
        echo '<td>
              <a class="" data-placement="top" href="'.base_url().'index.php/tours/activation_payment_policy/'.$data['id'].'/0"
        ...
        {
        echo '<td>
              <a class="" data-placement="top" href="'.base_url().'index.php/tours/activation_payment_policy/'.$data['id'].'/1"
              data-original-title="Activate Tour Destination"> <i class="glyphicon glyphicon-th-large"></i></i> Activate
              </a>
              </td>';
        }      
        echo '<td class="center">
              <a class="" data-placement="top" href="'.base_url().'index.php/tours/edit_payment_policy_data/'.$data['id'].'"
		...
		$(document).ready(function()
		{
          ...
          $(".callDelete").click(function() { 
            $id = $(this).attr('id'); //alert($id);
		        ...
		        if($response==true){ window.location='<?=base_url()?>index.php/tours/delete_payment_policy/'+$id; } else{}
           });
...
$( document ).ready(function (){
	...
	CKEDITOR.replace( 'b2b_description' );
	CKEDITOR.replace( 'b2c_description' );
