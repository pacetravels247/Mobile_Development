...
<div id="Package" class="bodyContent col-md-12">
	<div class="panel panel-default">
		...
		<form
          ...
          <a href="<?php echo base_url(); ?>index.php/tours/tour_list" style="color:white;" class="btn btn-primary">Go Back to Holiday List</a>
									</div>
								</div>
							</div>
						</div>
...
<script type="text/javascript">  
		$(document).ready(function()
		{
		    ...
		    if($response==true){ window.location='<?=base_url()?>index.php/tours/delete_tour_dep_date/'+$id+'/'+$tour_id+'/'+$tour_type; } else{}
           });
