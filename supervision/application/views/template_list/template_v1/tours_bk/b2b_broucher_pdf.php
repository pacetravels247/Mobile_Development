...
<?php } ?>
  ...
  <table cellspacing="0" cellpadding="" border="0" style="border-collapse: collapse; width: 100%; margin: 0px auto; font-family: cambria, serif; color:#405364;">
    <tbody>
      ...
      <tr>
        <td style="margin-left: auto;margin-right: auto;text-align: center;">
        <span style="width:100%; float:left"><img  style="width: 500px;height: 300px;" src="<?=SYSTEM_IMAGE_FULL_PATH_TO_EXTRA.$this->template->domain_images($tour_data['banner_image']);?>" alt="img" /></span>
        </td>
      </tr>
      <?php 
    ...
    <tr>
        <td>
          <h2 style="margin:0px auto;text-align:center;font-size: 14px;font-weight:600;">Departure Dates</h2>
          <p style="margin:0px auto;text-align: center;font-size: 14px;font-weight:600;">
            <?php 
      if($tour_data['package_type']=="fit"){
    ...
    <!--  <tr>
     ...
     <tr>
        <td>
          ...
          <p style="">
            <h1 style="text-align: left;font-size: 20px;font-weight: 600;border-bottom: 1px solid #ccc;">Detailed Itinerary</h1>
          </p>
        </td>
      </tr>
   ...
   // debug($tours_itinerary_dw);
    ...
    <tr>
      <td>
        ...
        <h1 style="text-align:center;font-size: 20px;font-weight:600;"><em>Tour Ends with Sweet Memories’…….</em></h1>
        </p>
      </td>
    </tr>
    <tr>
      <td>
        <p style="margin:-10px 0px;">
        <h1 style="text-align:left;font-size: 14px;font-weight:600;">Detailed Holiday Price: B2B Pricing</h1>
        </p>
        <ul>
