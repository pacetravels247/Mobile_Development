...
<div id="Package" class="bodyContent col-md-12">
	<div class="panel panel-default">
			...
			<div class="panel-title">
				<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
					...
					<li role="presentation" class="active" id="add_package_li"><a
						...
						data-toggle="tab">Cancellation Policy List </a></li>
		...
		<div class="panel-body">
			<!-- PANEL BODY START -->
			<form
				action="<?php echo base_url(); ?>index.php/tours/cancellation_data_save"
	...
	<!-- PANEL WRAP END -->
        ...
        foreach ($cancellation_list as $key => $data) {
        if($data['status']==1)
        {
        ...
        {
        echo '<td>
              <a class="" data-placement="top" href="'.base_url().'index.php/tours/activation_cancellation/'.$data['id'].'/0"
        ...
        {
        echo '<td>
              <a class="" data-placement="top" href="'.base_url().'index.php/tours/activation_cancellation/'.$data['id'].'/1"
              data-original-title="Activate Tour Destination"> <i class="glyphicon glyphicon-th-large"></i></i> Activate
              </a>
              </td>';
        }      
        echo '<td class="center">
              <a class="" data-placement="top" href="'.base_url().'index.php/tours/edit_cancellation_data/'.$data['id'].'"
		...
		$(document).ready(function()
		{
          ...
          $(".callDelete").click(function() { 
            $id = $(this).attr('id'); //alert($id);
		        ...
		        if($response==true){ window.location='<?=base_url()?>index.php/tours/delete_cancellation/'+$id; } else{}
           });
