...
<?php } ?>
  ...
  <tbody> 
  <tr>
  <td style="padding:20px;"><table cellspacing="0" cellpadding="10" border="0" style="border-collapse: collapse; width: 100%; margin: 0px auto; font-family: cambria, serif; color:#222;text-align: justify;word-spacing: 5px;">
    <tbody>
      <tr>
        <td style="padding:10px 10px 10px 0px;">
          <span style="float: left;"><img style="margin-bottom:0px; height:auto;" src="<?php echo SYSTEM_IMAGE_FULL_PATH_TO_EXTRA.$GLOBALS['CI']->template->domain_images($GLOBALS['CI']->application_domain_logo); ?>" alt="logo"></span>
...
"><?= $tour_data['package_name']; ?></h2>
    ...
    display: block;"><?=($tour_data['duration']+1);?> Days / <?=$tour_data['duration'].(($tour_data['duration']==1)? 'Night': 'Nights');?> </span>
      ...
      <tr>
        <td style="padding:0px 20px;margin-left: auto;margin-right: auto;text-align: center;">
	  ...
	  <tr>
        <td style="padding:0px 10px 10px 0">
          <h2 style="margin: 0 auto;text-align:center;font-size: 16.5px;line-height:20px;font-weight:600;color: #018798;">Departure Dates</h2>
           ...
           <!-- <p style="margin:0;">Overnight at hotel <?=$itinary['hotel_name']?></p>
            ...
            <span style="margin:0 0 2px; font-weight:bold">Meal Plan:
			  ...
			  foreach($imag_array as $im){
				  if($im!=''){
				echo '<img style="width:200px;height:200px;display: inline-block;margin:3px;
" src="'.SYSTEM_IMAGE_FULL_PATH_TO_EXTRA.$this->template->domain_images($im).'">';
				  }
			  }
		...
		<tr>
			<td style="padding:0px 10px 10px 0">
			  ...
			  <table class="table table-bordered" style="margin-right: auto;margin-left: auto;">
				<tr>
					<th style="padding: 5px;background: #f1f1f1;">Room Type</th>
					<th style="padding: 5px;background: #f1f1f1;">Per Person</th>
				</tr>
...
//debug($b2c_tour_price);					  
      ...
      <!--  <tr>
        ...
        <tr>
          <td style="border-bottom: 2px solid #eeeeee;">
            <h2 style="margin:5px 0;font-size: 16.5px; line-height:20px;color: #018798; font-weight:600">PACKAGE PRICE DOES NOT INCLUDES:
</h2>
            <p style="margin:0;white-space: normal;">
              <?php 
        ...
        <tr>
          <td style="border-bottom: 2px solid #eeeeee;">
            <h2 style="margin:5px 0;font-size: 16.5px; line-height:20px;color: #018798; font-weight:600"> GENERAL CONDITIONS & REMARKS:</h2>
            <p style="margin:0;white-space: normal;">
             <?php
