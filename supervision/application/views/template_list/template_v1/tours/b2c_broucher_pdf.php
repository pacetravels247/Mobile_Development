...
<?php } ?>
  <table cellspacing="0" cellpadding="" border="0" style="border: 2px solid #eeeeee; background: #ffffff; font-size: 14px;width: 100%; max-width: 600px; margin: 0px auto; font-family: cambria, serif; color:#405364;">
  <tbody>
  <tr>
  <td>
  <table cellspacing="0" cellpadding="" border="0" style="border-collapse: collapse; width: 100%; margin: 0px auto; font-family: cambria, serif; color:#405364;">
    <tbody>
      <tr>
      ...
      <tr>
        <td style="margin-left: auto;margin-right: auto;text-align: center;">
          ...
          <span style="font-size: 14px;"><?=($tour_data['duration']+1);?> Days / <?=$tour_data['duration'].(($tour_data['duration']==1)? 'Night': 'Nights');?> </span>
        </td>
      </tr>
      <tr>
        <td style="margin-left: auto;margin-right: auto;text-align: center;">
     ...
     <tr>
      ...
      if($tour_data['package_type']=="fit"){
       ...
       <h2 style="margin: 0 auto;text-align:center;font-size: 14px;font-weight:600;">Tour Type – <?=$tour_type?> || Tour Code - <?=$tour_data['tour_code']?>
</h2>
        </td>
      </tr>
    <tr>
        <td>
          <h2 style="margin: 0 auto;text-align:center;font-size: 14px;font-weight:600;">Departure Dates</h2>
          <p style="margin:0 auto;text-align: center;font-size: 14px;font-weight:600;">
            <?php 
      if($tour_data['package_type']=="fit"){
    ...
    <!--  <tr>
     ...
     <tr>
        <td>
          ...
          <p style="margin:0;">
            <h1 style="text-align: left;font-size: 14px;font-weight: 600;border-bottom: 1px solid #ccc;">Detailed Itinerary</h1>
          </p>
        </td>
      </tr>
   ...
   // debug($tours_itinerary_dw);
    ...
    //echo $visited_city;
        ...
        <tr>
          <td>
           ...
           <!-- <p style="margin:0;">Overnight at hotel <?=$itinary['hotel_name']?></p>
            ...
            <div style="font-weight:bold">Meal Plan:
        ...
        foreach($imag_array as $im){
          if($im!=''){
        echo '<img style="width:250px;height:150px;display:block;margin-left:auto;margin-right:auto;text-align:center;" src="'.$this->template->domain_images($im).'">';
          }
        }
    ...
    <tr>
      <td>
        <p>
        <h1 style="text-align:left;font-size: 14px;font-weight:600;">Detailed Holiday Price: B2C Pricing</h1>
        </p>
        <ul>
...
//debug($b2c_tour_price);           
    ...
    <tr>
          <td style="border-bottom: 2px solid #eeeeee;">
            <h2 style="font-size: 14px; font-weight:600">ACCOMMODATION</h2>
        ...
        <tr>
          <td style="border-bottom: 2px solid #eeeeee;">
            <h2 style="font-size: 14px; font-weight:600">PACKAGE PRICE INCLUDES:</h2>
            <p style="margin:0;white-space: normal;">
              <?php 
        ...
        <tr>
          <td style="border-bottom: 2px solid #eeeeee;">
            <h2 style="font-size: 14px; font-weight:600">PACKAGE PRICE DOES NOT INCLUDES:
</h2>
            <p style="margin:0;white-space: normal;">
              <?php 
        ...
        <tr>
          <td style="border-bottom: 2px solid #eeeeee;">
            <h2 style="font-size: 14px; font-weight:600"> GENERAL CONDITIONS & REMARKS:</h2>
            <p style="margin:0;white-space: normal;">
             <?php
      ...
      <tr style="border-bottom: 2px solid #eeeeee;">
            <td>
              <h1 style="font-size: 14px; font-weight:600">TRIP NOTE:</h1>
             ...
             <tr>
            <td>
              <h1 style="font-size: 14px; font-weight:600">VISA PROCEDURES</h1>
              <p style="margin:0;white-space: normal;font-size: 13px;">
      ...
      <!-- <tr style="border-bottom: 2px solid #eeeeee;">
       ...
       <tr >
            <td>
              <h1 style="font-size: 14px; font-weight:600">PAYMENT POLICY:</h1>
              <p style="margin:0;white-space: normal;font-size: 13px;">
          ...
          <tr>
            <td>
              <h1 style="font-size: 14px; font-weight:600">CANCELLATION POLICY:</h1>
              <p style="margin:0;white-space: normal;font-size: 13px;">
                <?php $tours_itinerary['canc_policy'] = str_replace('\n', '', $tour_data['canc_policy']);
