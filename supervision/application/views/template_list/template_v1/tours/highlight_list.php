...
<div id="Package" class="bodyContent col-md-12">
   <div class="panel panel-default">
         ...
         <div class="panel-title">
            <ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
               ...
               <li role="presentation" class="active" id="add_package_li"><a
                  ...
                  data-toggle="tab">highlight List </a></li>
      ...
      <div class="panel-body">
         <!-- PANEL BODY START -->
         <form
            action="<?php echo base_url(); ?>index.php/tours/highlight_data_save"
         ...
         <table class="table table-bordered">
            ...
            <tbody>		
               <?php
                  ...
                  foreach ($highlight_list as $key => $data) {
                  if($data['status']==1)
                  {
                  ...
                  {
                  echo '<td>
                        <a class="" data-placement="top" href="'.base_url().'index.php/tours/activation_highlight/'.$data['id'].'/0"
                  ...
                  {
                  echo '<td>
                        <a class="" data-placement="top" href="'.base_url().'index.php/tours/activation_highlight/'.$data['id'].'/1"
                        data-original-title="Activate Tour Destination"> <i class="glyphicon glyphicon-th-large"></i></i> Activate
                        </a>
                        </td>';
                  }      
                  echo '<td class="center">
                        <a class="" data-placement="top" href="'.base_url().'index.php/tours/edit_highlight_data/'.$data['id'].'"
...
<script type="text/javascript">  
   $(document).ready(function()
   {
           ...
           if($response==true){ window.location='<?=base_url()?>index.php/tours/delete_highlight/'+$id; } else{}
            });
