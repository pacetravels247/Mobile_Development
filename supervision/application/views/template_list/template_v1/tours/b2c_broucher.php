...
<?php  if($menu == true){ ?>
  <div class="container">
    <div class="col-xs-12 text-center mt10">
      <ul class="list-inline btn_sec">
        ...
        <li>
        <a href="<?php echo base_url () . 'index.php/tours/b2c_voucher/'.$tour_id.'/show_pdf';?>"  ><button class="btn-sm btn-primary pdf">PDF</button></a>
       </li>
       <li>
       <?php 
 ...
 <div class="collapse" id="emailmodel">
  <div class="well max_wd20">
    <h4>Send Email</h4>
    <form name="agent_email" method="post" action="<?php echo base_url () . 'index.php/tours/b2c_voucher/'.$tour_id.'/show_broucher/mail';?>">
...
<?php } ?>
  <table cellspacing="0" cellpadding="10" border="0" style="border: 2px solid #eeeeee; background: #ffffff; font-size: 14px; line-height: 20px; width: 100%; max-width: 600px; margin: 0px auto; font-family: cambria, serif; color:#222;text-align: justify;word-spacing: 5px;">
  <tbody>
  <tr>
  ...
  <table cellspacing="0" cellpadding="10" border="0" style="border-collapse: collapse; width: 100%; margin: 0px auto; font-family: cambria, serif; color:#222;text-align: justify;word-spacing: 5px;">
    <tbody>
      ...
      <tr>
        <td style="padding:0px 10px 20px 0px;margin-left: auto;margin-right: auto;text-align: center;">
          <h2 style="margin:15px 0 0;font-size: 26px; line-height:20px; font-weight:600"><?= $tour_data['package_name']; ?></h2>
          <span style="margin:0 0 2px;font-size: 20px;"><?=($tour_data['duration']+1);?> Days / <?=$tour_data['duration'].(($tour_data['duration']==1)? 'Night': 'Nights');?> </span>
        </td>
      </tr>
      <tr>
	  ...
	  <tr>
        <td style="padding:0px 10px 10px 0">
          <h2 style="margin: 0 auto;text-align:center;font-size: 16.5px;line-height:20px;font-weight:600;">Departure Dates</h2>
    ...
    <!--  <tr>
	   ...
	   <tr>
        <td style="padding:0px 10px 10px 0">
          ...
          <p style="margin:0;">
            <h1 style="text-align: left;font-size: 20px;line-height: 20px;font-weight: 600;border-bottom: 1px solid #ccc;padding: 5px;">Detailed Itinerary</h1>
          </p>
        </td>
      </tr>
	 ...
	 // debug($tours_itinerary_dw);
      foreach ($tours_itinerary_dw as $key => $itinary) {
           ...
           <!-- <p style="margin:0;">Overnight at hotel <?=$itinary['hotel_name']?></p>
            ...
            <span style="margin:0 0 2px; font-weight:bold">Meal Plan:
			  ...
			  foreach($imag_array as $im){
				  if($im!=''){
				echo '<img style="width:150px;height:150px;display: inline-block;margin: 2px 5px;" src="'.SYSTEM_IMAGE_FULL_PATH_TO_EXTRA.$this->template->domain_images($im).'">';
				  }
			  }
		...
		<tr>
			<td style="padding:0px 10px 10px 0">
			  <p style="margin:0;">
				<h1 style="text-align:left;font-size: 16.5px;line-height:20px;font-weight:600;">Detailed Holiday Price: B2C Pricing</h1>
			  </p>
			  <ul>
      ...
      <!--  <tr>
		...
		<tr>
          <td style="border-bottom: 2px solid #eeeeee;">
            <h2 style="margin:5px 0;font-size: 16.5px; line-height:20px; font-weight:600">ACCOMMODATION</h2>
		...
		<tr>
          <td style="border-bottom: 2px solid #eeeeee;">
            <h2 style="margin:5px 0;font-size: 16.5px; line-height:20px; font-weight:600">HIGHLIGHTS</h2>
            <p style="margin:0;white-space: normal;">
              <?php 
              $tours_itinerary['highlights'] = str_replace('\n', '', $tour_data['highlights']);
              echo htmlspecialchars_decode($tours_itinerary['highlights']); 
              ?>
            </p>
          </td>
        </tr>
        <tr>
          <td style="border-bottom: 2px solid #eeeeee;">
            <h2 style="margin:5px 0;font-size: 16.5px; line-height:20px; font-weight:600">PACKAGE PRICE INCLUDES:</h2>
            <p style="margin:0;white-space: normal;">
              <?php 
        ...
        <tr>
          <td style="border-bottom: 2px solid #eeeeee;">
            <h2 style="margin:5px 0;font-size: 16.5px; line-height:20px; font-weight:600">PACKAGE PRICE DOES NOT INCLUDES:
</h2>
            <p style="margin:0;white-space: normal;">
              <?php 
        ...
        <tr>
          <td style="border-bottom: 2px solid #eeeeee;">
            <h2 style="margin:5px 0;font-size: 16.5px; line-height:20px; font-weight:600"> GENERAL CONDITIONS & REMARKS:</h2>
            <p style="margin:0;white-space: normal;">
             <?php
		  ...
		  <tr style="border-bottom: 2px solid #eeeeee;">
            <td style="padding:0px 10px 15px 0">
              <h1 style="margin:5px 0;font-size: 16.5px; line-height:20px; font-weight:600">TRIP NOTE:</h1>
             ...
             <tr>
            <td style="padding:0px 10px 15px 0">
              <h1 style="margin:5px 0;font-size: 16.5px; line-height:20px; font-weight:600">VISA PROCEDURES</h1>
              <p style="margin:0;white-space: normal;font-size: 13px;">
        ...
        <table>
			 ...
			 <tr >
            <td style="padding:0px 10px 15px 0">
              <h1 style="margin:5px 0;font-size: 16.5px; line-height:20px; font-weight:600">PAYMENT POLICY:</h1>
              <p style="margin:0;white-space: normal;font-size: 13px;">
                <?php $tours_itinerary['canc_policy'] = str_replace('\n', '', $tour_data['canc_policy']);

                echo htmlspecialchars_decode($tour_data['b2c_payment_policy']); ?></p>
              </td>
            </tr>
			
          <tr>
            <td style="padding:0px 10px 15px 0">
              <h1 style="margin:5px 0;font-size: 16.5px; line-height:20px; font-weight:600">CANCELLATION POLICY:</h1>
              <p style="margin:0;white-space: normal;font-size: 13px;">
                <?php $tours_itinerary['canc_policy'] = str_replace('\n', '', $tour_data['canc_policy']);
