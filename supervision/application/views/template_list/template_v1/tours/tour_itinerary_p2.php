													...
													<div class="images_div">
														<div class="gallery_div col-sm-offset-3" id="gallery_div_<?=$Dayno?>">
															...
															//debug($tours_itinerary_dw);
																...
																foreach($image as $im){
																	if($im!=''){
																		echo '<img src="'.$this->template->domain_images($im).'"style="width:100px;height:100px;margin:5px 0 10px 10px;"><a data-ite_id="'.$tours_itinerary_dw[$Dayno-1]['id'].'" data-ite_img_nam="'.$im.'" class="delete_image"><i class="fas fa-trash"></i></a>';
																	}
                                                   ...
                                                   <!-- <div class="form-group">
													...
													<div class="images_div">
														...
														<div class='form-group'>
															...
															<div class='col-sm-4 controls'>
																<input type="file" name="gallery[<?= $Dayno?>][]" multiple data-rule-required='true' class='form-control gallery' >				<?=img_size_msg(610,370)?>	 					
															</div>
														</div>
													</div>
                                                   <!-- <div class="form-group">
                                                ...
                                                <div class='row'>
                                                    <div class='col-sm-9 col-sm-offset-3'>
                                                       ...
                                                       /* if($this->session->userdata('edit_itinary')){
														...
														?>
															<a class='btn btn-primary' href="<?php echo base_url(); ?>index.php/tours/draft_list">Draft List</a>
															<?php
															}else if($tour_data['package_status']=='ITINERARY_ADDED'){
															?>
															<a class='btn btn-primary' href="<?php echo base_url(); ?>index.php/tours/tour_list">Holiday List</a>
															<?php
															}else if($tour_data['package_status']=='VERIFICATION'){
															?>
															<a class='btn btn-primary' href="<?php echo base_url(); ?>index.php/tours/verify_tour_list">Verify Holiday List</a>
															<?php
															}else if($tour_data['package_status']=='VERIFIED'){
															?>
															<a class='btn btn-primary' href="<?php echo base_url(); ?>index.php/tours/published_tour_list">Published Holiday List</a>
															<?php } ?>
