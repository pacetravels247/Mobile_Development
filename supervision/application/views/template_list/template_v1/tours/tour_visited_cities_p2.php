			...
			<div class="panel-title">
				<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
					...
					<li role="presentation" class="active" id="add_package_li"><a
						...
						data-toggle="tab"> Visited City List : [ <?php echo 'Package Name : '.string_replace_encode($tour_data['package_name']);?>]</a>
					</li>			        
				</ul>
			</div>
		</div>
				...
				<div class="tab-content">
					...
					<div role="tabpanel" class="tab-pane active" id="add_package">
						    ...
						    <div class='form-group'>
								<label class='control-label col-sm-3' for='validation_current'>Package Duration <span style = "color:red">*</span>
								</label>
