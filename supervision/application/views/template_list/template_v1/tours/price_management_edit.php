...
--> 
      ...
      <a class='btn btn-primary' href="<?php echo base_url() ."index.php/tours/price_management/".$price_details_single[0]['tour_id']; ?>/<?=$price_details_single[0]['package_type']?>/<?=$list?>">Cancel</a>
  </div>
      </div>
   </form>
</div>
