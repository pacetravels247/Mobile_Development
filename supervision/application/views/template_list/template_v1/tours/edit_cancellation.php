...
<div id="Package" class="bodyContent col-md-12">
    <div class="panel panel-default">
            ...
            <div class="panel-title">
                <ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
                    ...
                    <li role="presentation" class="active" id="add_package_li"><a
                            ...
                            data-toggle="tab">Edit Cancellation </a></li>			
                </ul>
            </div>
        </div>
        <!-- PANEL HEAD START -->
        <div class="panel-body">
            <!-- PANEL BODY START -->
            <form
                action="<?php echo base_url(); ?>index.php/tours/edit_cancellation_save"
                        ...
                        <div class="col-md-12">
							...
							<div class='form-group'>
								...
								<div class='col-sm-8 controls'>
									<textarea	name="description" required id="editor"><?=$cancellation_details['desctiption']?></textarea>									
								</div>
							</div>		
                                ...
                                <div class='row'>
                                    <div class='col-sm-9 col-sm-offset-3'>	
                                       <input type="hidden" name="id" value="<?=$cancellation_details['id']?>">				
                                        ...
                                        <a href="<?php echo base_url(); ?>index.php/tours/cancellation_list" class='btn btn-primary' style="color:white;">Cancel</a>
