...
<div style="background:#ccc; width:100%; position:relative">
    <table cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:9pt;font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
        <tbody>
            ...
            <tr>
                <td colspan="2" style="padding-bottom:10px" class="voucher_logo"><img alt="No Logo"  src="<?= $GLOBALS['CI']->template->domain_full_images($data['logo']) ?>" style="height: 50px;"/></td>
...
# Checking Cabin Baggage
        ...
        if (is_int($segment_details_v['cabin_baggage'])) {
            ...
            <tr>
                ...
                <td><span style="display:block;border-left: 1px solid #999;"><?php echo $non_stop; echo " | ".$segment_details_v['total_duration']; ?><br><?php echo $segment_details_v['is_refundable'];
                 ?></span></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
...
<?php } ?>
                <tr>
                    ...
                    <td style="border-top:1px solid #ccc"><span style="font-size:11px"> <?= number_format(@$booking_details['grand_total']+ $booking_details['agent_markup'] + $seat_price + $meal_price + $baggage_price, 2) ?></span></td>
                </tr>
            </tbody>
        </table>
    </td>
    ...
    <div style="background:#ccc; width:100%; position:relative">
        <table class="pag_brk" cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:9pt; font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
            <tbody>
                ...
                <tr>
                    <td align="right" colspan="4" style="line-height:25px;font-size:12px; border-top:2px solid #00a9d6; border-bottom:1px solid #00a9d6;"><span style="font-size:9pt;">Status: </span><strong class="<?php echo booking_status_label($booking_transaction_details[1]['status']) ?>" style=" font-size:12px;">
                            <?php
