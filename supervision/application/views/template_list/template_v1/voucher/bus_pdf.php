                              ...
                              <tr>
                                 <td>
                                    <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                       <tbody>
                                          <tr>
                                             <td colspan="2" valign="bottom" style="padding-bottom:10px;"><img style="width:100px;" src="<?=$GLOBALS['CI']->template->domain_full_images($agent_logo)?>" /></td>
                              ...
                              <tr>
                                 <td style="padding:0;">
                                    <table cellspacing="0" cellpadding="0" style="font-size:9pt; padding:0;line-height:normal;">
                                       <tbody>
                                          <tr>
                                             <td width="42%" style="padding:10px 0; vertical-align:middle;"><span style="display: block;"><span style="font-size:11pt;font-weight: 600;">Boarding Point</span><br><span style="font-size:10pt;vertical-align:middle; "><?php echo $itineray_details['boarding_from'];?></span></span></td>
                                             <td width="3%">&nbsp;</td>
                                             <td width="30%" style="padding:10px 0; vertical-align:middle;"><span style="display: block;"><span style="font-size:11pt;font-weight: 600;">Dropping at</span><br><span style="font-size:10pt;vertical-align:middle;"><?php echo $itineray_details['dropping_at'];?></span></span></td>
                                             <td width="25%" style="padding:0;line-height:normal;">
                                                <table cellspacing="0" cellpadding="0" style="font-size:9pt; padding:0;line-height:normal;">
                                                   <tbody>
                                                      <tr>
