               ...
               <tbody>
                  <tr>
                              ...
                              <tr>
                                 <td>
                                    <table width="100%" style="font-family: 'Open Sans', sans-serif;border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                       <tbody>
                                          <tr>
                                             <td style="padding: 0px;"><img style="width: 100px;" src="<?=$GLOBALS['CI']->template->domain_images($agent_logo)?>"></td>
                                             <td style="padding: 0px;">
                                                <table width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif;border-collapse: collapse;text-align: right; line-height:15px;" cellpadding="0" cellspacing="0" border="0">                                     
                                                   <tbody>
                                                      <tr>
                                                         <td style="padding-bottom:10px;line-height:20px" align="right"><?=$data['domainname']?> <br>ContactNo : <?=$data['phone_code']?><?=$data['phone']?><br>
                                 <?=$data['address']?><br><span>Booked Date : <?php echo $booking_details['booked_date'];?></span></td>
                                                      </tr>
                                                   </tbody>
                                                </table>
                                             </td>
                     ...
                     <tr>
                           ...
                           <td width="40%" style="padding:5px 0; line-height:25px;"><span style="display: block;"><span style="font-size:14px;font-weight: 600;">Boarding Point</span><br><span style="font-size:14px;vertical-align:middle;"><?php echo $itineray_details['boarding_from'];?></span></span></td>
                           <td width="30%" style="padding:padding:5px 14px 0px 30px; line-height:25px;vertical-align: top;"><span style="display: block;"><span style="font-size:14px;font-weight: 600;">Dropping at</span><br><span style="font-size:14px;vertical-align:middle;"><?php echo $itineray_details['dropping_at'];?></span></span></td>
