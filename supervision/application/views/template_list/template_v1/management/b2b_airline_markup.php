	...
	<div class="panel <?=PANEL_WRAPPER?>"><!-- PANEL WRAP START -->
		<div class="panel-heading"><!-- PANEL HEAD START -->
			<div class="panel-title">
				<i class="fa fa-edit"></i> Manage B2B Application Markup
			...
			<fieldset><legend><i class="fa fa-plane"></i> Add Airline  <i class=" fa fa-plus"></i></legend>
				...
				<div class="row">
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								<label for="new_airline_value_i" class="col-sm-4 control-label">International</label>
				...
				?>
						...
						<div class="row">
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									<label for="specific-value-<?=$__airline_index?>" class="col-sm-4 control-label">Inernational</label>
