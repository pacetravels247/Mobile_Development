<form name="group_generic" action="<?php echo base_url().'index.php/management/group_commission'; ?>" method="post">
   <div class="org_row">
      <div class="col-md-6">
   ...
   <div class="col-xs-12 spl_lst nopad">
      <div class="panel-body">
         <fieldset>
            ...
            <form action="<?php echo base_url().'index.php/management/add_operator_wise_commission' ?>"  method="POST" autocomplete="off">
               <div class="hide">
                  <input type="hidden" name="group_fk" value="<?php echo $group_fk; ?>">
...
<fieldset>
   ...
   <form action="<?php echo base_url().'index.php/management/add_airline_wise_commission' ?>" class="form-horizontal" method="POST" autocomplete="off">
      <div class="hide">
...
<fieldset>
   ...
   <form action="<?php echo base_url().'index.php/management/add_airline_wise_commission' ?>" method="POST" autocomplete="off">
      <input type="hidden" class="" name="update" value="update">
