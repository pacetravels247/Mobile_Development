<form name="group_generic" action="<?php echo base_url().'index.php/management/agent_commissions'; ?>" method="post">
   <div class="org_row">
   <div class="col-md-6">
      <label for="new_airline_value" class="col-sm-3 control-label">Generic<span class="text-danger">*</span></label>                                
      <div class="col-md-9">
         <div class="form-group mb20">
            <input class="form-control" type="text" name="group_generic_value" value="<?php echo $generic['value']; ?>">
            ...
            <input type="hidden" name="user_oid" value="<?php echo $agent_fk; ?>">
           ...
           <!--  <div class="input-group-btn">
               <input class="input-group-text form-control gnr_btn" type="submit" name="submit">
            </div> -->
         </div>
      </div>
    </div>
...
<?php foreach($specific as $s_key => $s_val) { ?>
   <div class="col-md-4">
      ...
      <div class="col-md-7 mb10">
		<input class="form-control" type="text" name="specific_value[]" value="<?php echo $s_val['value']; ?>">
		<input type="hidden" name="user_oid" value="<?php echo $agent_fk; ?>">
   ...
   <div class="col-xs-12 spl_lst nopad">
      <div class="panel-body">
         <fieldset>
            ...
            <form action="<?php echo base_url().'index.php/management/add_agent_operator_wise_commission' ?>" method="POST" autocomplete="off">
               <div class="hide">
                  <input type="hidden" name="agent_fk" value="<?php echo $agent_fk; ?>">
               ...
               <?php foreach ($bitla_operators as $bitla_key => $bitla_value) { ?>
                  <div class="row mrk_lst">
                     <div class="col-md-4">
                        ...
                        <input type="hidden" name="comm_source[]" value="<?=$bitla_value['commission_details']['origin']?>">                               
                        <!-- <div class="col-md-7 mb10"> 
         ...
         <fieldset>
            ...
            <form action="<?php echo base_url().'index.php/management/add_agent_operator_wise_commission' ?>" method="POST" autocomplete="off">
               ...
               <?php 
                  ...
                  ?>
               <input type="hidden" name="origin[]" value="<?=$value['origin']?>"><div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="col-md-7 mb10"> 
                        <input type="text" id="" class="form-control" name="value[]" class=" specific-value numeric" placeholder="Commission Value" value="<?=$value['value']?>">
                     </div>
                  </div>
               </div>
               <?php } ?>		
   ...
   <div class="col-md-5">
      ...
      <div class="col-md-9 mb10 nopad">
         ...
         <fieldset>
            ...
            <form action="<?php echo base_url().'index.php/management/add_airline_airline_wise_commission' ?>" class="form-horizontal" method="POST" autocomplete="off">
               <div class="hide">
