...
<div class="panel panel-primary">
   <div class="panel-heading">
      ...
      <div class="panel-title">
         <i class="fa fa-edit"></i> Group Commission
      </div>
   </div>
...
<script type="text/javascript">
   $(document).ready(function(){
   	...
   	$.post( base_url+'index.php/management/get_suppliers', { module: $("input[name='module']:checked").val(), group_fk:$('#group').val(), trip_type : 'domestic', tp_supplier : '<?=TRAVELPORT_GDS_BOOKING_SOURCE?>' })
   		  .done(function( data ) {
   			$('#display_supplier_list').html(data);		    
   		  });
   	/*$('.module, .group').change(function(){
   		$.post( base_url+'index.php/management/get_suppliers', { module: $("input[name='module']:checked").val(), group_fk:$('#group').val() })
   		  .done(function( data ) {
   			$('#display_supplier_list').html(data);		    
   		  });
   	});*/
   	$(document).on('change','.trip_type, #tp_supplier, .module, .group', function(){
         ...
         $('.selected_supplier_specific').val(supplier);
   		$.post( base_url+'index.php/management/get_suppliers', { module: $("input[name='module']:checked").val(), group_fk:$('#group').val(), trip_type : tirp_type, tp_supplier : supplier })
   		  .done(function( data ) {
   			$('#display_supplier_list').html(data);		    
   		  });
   	});
