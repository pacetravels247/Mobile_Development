...
$form_configuration['inputs'] = array(
	...
	'gst_number' 	   => array('type' => 'text',     'label_line_code' => 256, 'mandatory' => false, 'maxlength' => 15),
	...
	'office_phone' 		   => array('type' => 'number',   'label_line_code' => 266, 'maxlength' => '10', 'DT' => 'PROVAB_SOLID_I10'),
...
'form_header' => $form_attributes,
		'sections' => array(
			array('elements' => array('user_id', 'title', 'first_name', 'last_name', 'date_of_birth', 'country_code', 'phone', 'office_phone', 'address', 'status', 'language_preference','image'),
				'fieldset' => 'FFL003'
			),
...
$form_configuration['form']['user_edit'] = array(
		'form_header' => $form_attributes,
		'sections' => array(
			array('elements' => array('user_id', 'title', 'first_name', 'last_name', 'gst_name', 'gst_number', 'gst_phone', 'gst_email', 'gst_address', 'date_of_birth', 'country_code', 'phone', 'office_phone', 'address', 'status', 'language_preference','image'),
				'fieldset' => 'FFL003'
			),
