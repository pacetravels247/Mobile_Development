...
$form_configuration['inputs'] = array(
	...
	'office_phone'	   => array('type' => 'text',   'label_line_code' => 216, 'DT' => 'PROVAB_SOLID_I10', 'maxlength' => 12),
...
'form_header' => $form_attributes,
		'sections' => array(
			array('elements' => array('agency_name','pan_number', 'office_phone','image','comm_group'), 'fieldset' => 'FFL0049'
			),
...
$form_configuration['form']['b2b_user_edit'] = array(
		'form_header' => $form_attributes,
		'sections' => array(
			array('elements' => array('agency_name', 'pan_number','office_phone','image','comm_group'),
					'fieldset' => 'FFL0049'
			),
			array('elements' => array('gst_number', 'gst_name', 'gst_email', 'gst_phone', 'gst_address', 'gst_certificate'), 'fieldset' => 'FFL0054'),
			array('elements' => array('user_id', 'title', 'first_name', 'last_name', 'date_of_birth', 'country_code', 'phone','country_name','city','address', 'status', 'language_preference'),
